...
***************************************/
    ...
    volatile uint8 UART_Debug_txBuffer[UART_Debug_TXBUFFERSIZE];
    ...
    volatile uint8 UART_Debug_rxBuffer[UART_Debug_RXBUFFERSIZE];
    ...
    volatile uint8 UART_Debug_rxBufferOverflow = 0u;
        ...
        volatile uint8 UART_Debug_rxAddressMode = UART_Debug_RXADDRESSMODE;
...
*  to the UART_Debug_Start() routine. 
*
* Reentrant:
*  No.
*
...
void UART_Debug_Init(void) 
{
            ...
            CyIntSetVector(UART_Debug_RX_VECT_NUM,   UART_Debug_RXISR);
            CyIntSetPriority(UART_Debug_RX_VECT_NUM, UART_Debug_RX_PRIOR_NUM);
        #endif /* End UART_Debug_RX_INTERRUPT_ENABLED */

        #if (UART_Debug_RXHW_ADDRESS_ENABLED)
            UART_Debug_SetRxAddressMode(UART_Debug_RXAddressMode);
            UART_Debug_SetRxAddress1(UART_Debug_RXHWADDRESS1);
            UART_Debug_SetRxAddress2(UART_Debug_RXHWADDRESS2);
        ...
        #if(UART_Debug_TX_INTERRUPT_ENABLED && (UART_Debug_TXBUFFERSIZE > UART_Debug_FIFO_LENGTH))
            /* Set the TX Interrupt. */
            CyIntSetVector(UART_Debug_TX_VECT_NUM,   UART_Debug_TXISR);
        ...
        /* Write Counter Value for TX Bit Clk Generator*/
            ...
            UART_Debug_TXBITCLKTX_COMPLETE_REG = (UART_Debug_NUMBER_OF_DATA_BITS + \
                                                    UART_Debug_NUMBER_OF_START_BIT) * \
                                                    UART_Debug_OVER_SAMPLE_COUNT;
        #else
            UART_Debug_TXBITCTR_COUNTER_REG = (UART_Debug_NUMBER_OF_DATA_BITS + \
                                                    UART_Debug_NUMBER_OF_START_BIT) * \
                                                    UART_Debug_OVER_SAMPLE_8;
        ...
        UART_Debug_WriteControlRegister( \
            (UART_Debug_ReadControlRegister() & ~UART_Debug_CTRL_PARITY_TYPE_MASK) | \
            (UART_Debug_PARITY_TYPE << UART_Debug_CTRL_PARITY_TYPE0_SHIFT) );
...
void UART_Debug_Enable(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
        ...
        #if(UART_Debug_RX_INTERRUPT_ENABLED && (UART_Debug_RXBUFFERSIZE > UART_Debug_FIFO_LENGTH))
            CyIntEnable(UART_Debug_RX_VECT_NUM);
            #if (UART_Debug_RXHW_ADDRESS_ENABLED)
        ...
        #if(UART_Debug_TX_INTERRUPT_ENABLED && (UART_Debug_TXBUFFERSIZE > UART_Debug_FIFO_LENGTH))
            CyIntEnable(UART_Debug_TX_VECT_NUM);
        #endif /* End UART_Debug_TX_INTERRUPT_ENABLED*/
     #endif /* End UART_Debug_TX_ENABLED */

    #if(UART_Debug_INTERNAL_CLOCK_USED)
        /* Set the bit to enable the clock. */
        UART_Debug_INTCLOCK_CLKEN_REG |= UART_Debug_INTCLOCK_CLKEN_MASK;
...
void  UART_Debug_WriteControlRegister(uint8 control) 
{
       ...
       UART_Debug_CONTROL_REG = control;
        ...
        /*******************************************************************************
        * Function Name: UART_Debug_EnableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Debug_EnableRxInt(void) 
        {
            CyIntEnable(UART_Debug_RX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_Debug_DisableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Debug_DisableRxInt(void) 
        {
            CyIntDisable(UART_Debug_RX_VECT_NUM);
        }
    ...
    *  UART_Debug_rxBufferLoopDetect - creared if loop condition was detected
    *     in RX ISR. 
    *
    * Reentrant:
    *  No.
    ...
    *******************************************************************************/
    uint8 UART_Debug_ReadRxData(void) 
    {
        uint8 rxData;
        ...
        #if(UART_Debug_RXBUFFERSIZE > UART_Debug_FIFO_LENGTH)
                ...
                (UART_Debug_rxBufferLoopDetect > 0u) )
            {
                ...
                rxData = UART_Debug_rxBuffer[UART_Debug_rxBufferRead];

                UART_Debug_rxBufferRead++;

                if(UART_Debug_rxBufferRead >= UART_Debug_RXBUFFERSIZE)
                {
        ...
        #else /* UART_Debug_RXBUFFERSIZE > UART_Debug_FIFO_LENGTH */

            /* Needs to check status for RX_STS_FIFO_NOTEMPTY bit*/
            rxData = UART_Debug_RXDATA_REG;

        #endif /* UART_Debug_RXBUFFERSIZE > UART_Debug_FIFO_LENGTH */
    ...
    *******************************************************************************/
    uint8 UART_Debug_ReadRxStatus(void) 
    {
        ...
        status = UART_Debug_RXSTATUS_REG;
        status &= UART_Debug_RX_HW_MASK;

        #if(UART_Debug_RXBUFFERSIZE > UART_Debug_FIFO_LENGTH)
            if( UART_Debug_rxBufferOverflow )
            {
                status |= UART_Debug_RX_STS_SOFT_BUFF_OVER;
                UART_Debug_rxBufferOverflow = 0u;
            }
        #endif /* UART_Debug_RXBUFFERSIZE */
    ...
    uint8 UART_Debug_GetChar(void) 
    {
        ...
        uint8 rxStatus;
            ...
            {   rxStatus =UART_Debug_RXSTATUS_REG;
                if(rxStatus & UART_Debug_RX_STS_FIFO_NOTEMPTY)
    ...
    *******************************************************************************/
                                                            ...
                                                            
    {
        uint8 size;
            ...
            {
                size = (UART_Debug_RXBUFFERSIZE - UART_Debug_rxBufferRead) + UART_Debug_rxBufferWrite;
            }
            ...
            size = (UART_Debug_RXSTATUS_REG & UART_Debug_RX_STS_FIFO_NOTEMPTY) ? 1u : 0u;
    ...
    *******************************************************************************/
    void UART_Debug_ClearRxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();        
        UART_Debug_RXDATA_AUX_CTL_REG |=  UART_Debug_RX_FIFO_CLR;
        UART_Debug_RXDATA_AUX_CTL_REG &= ~UART_Debug_RX_FIFO_CLR;
    ...
    *******************************************************************************/
                                                        ...
                                                        
    {
                ...
                uint8 tmpCtrl = 0u;
                tmpCtrl = UART_Debug_CONTROL_REG & ~UART_Debug_CTRL_RXADDR_MODE_MASK;
                tmpCtrl |= ((addressMode << UART_Debug_CTRL_RXADDR_MODE0_SHIFT) & 
                           UART_Debug_CTRL_RXADDR_MODE_MASK);
    ...
    *******************************************************************************/
    void UART_Debug_SetRxAddress2(uint8 address) 
    {
        ...
        /*******************************************************************************
        * Function Name: UART_Debug_EnableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Debug_EnableTxInt(void) 
        {
            CyIntEnable(UART_Debug_TX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_Debug_DisableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Debug_DisableTxInt(void) 
        {
            CyIntDisable(UART_Debug_TX_VECT_NUM);
        }
    ...
    *******************************************************************************/
    void UART_Debug_WriteTxData(uint8 txDataByte) 
    {
        ...
        if(UART_Debug_initVar != 0u)
        {
            #if(UART_Debug_TXBUFFERSIZE > UART_Debug_FIFO_LENGTH)
                ...
                {
                    if(UART_Debug_txBufferWrite >= UART_Debug_TXBUFFERSIZE)
                    {
                        UART_Debug_txBufferWrite = 0;
                    }
            ...
            #else /* UART_Debug_TXBUFFERSIZE > UART_Debug_FIFO_LENGTH */

                /* Add directly to the FIFO. */
                UART_Debug_TXDATA_REG = txDataByte;

            #endif /* End UART_Debug_TXBUFFERSIZE > UART_Debug_FIFO_LENGTH */
        }
    }
    ...
    *******************************************************************************/
    void UART_Debug_PutChar(uint8 txDataByte) 
    {
                ...
                while( UART_Debug_txBufferWrite == (UART_Debug_txBufferRead - 1u) ||
                    (uint8)(UART_Debug_txBufferWrite - UART_Debug_txBufferRead) ==
                    (uint8)(UART_Debug_TXBUFFERSIZE - 1u) )
                {
                ...
                while(UART_Debug_TXSTATUS_REG & UART_Debug_TX_STS_FIFO_FULL);
    ...
    *
    *******************************************************************************/
    void UART_Debug_PutString(char* string) 
    {
        /* If not Initialized then skip this function*/
        if(UART_Debug_initVar != 0u)
        {
    ...
    *
    *******************************************************************************/
    void UART_Debug_PutArray(uint8* string, uint8 byteCount) 
    ...
    *******************************************************************************/
                                                            ...
                                                            
    {
        uint8 size;
            ...
            {
                size = (UART_Debug_TXBUFFERSIZE - UART_Debug_txBufferRead) + UART_Debug_txBufferWrite;
            }
            ...
            /* Is the fifo is full. */
            if(size & UART_Debug_TX_STS_FIFO_FULL)
            {
                size = UART_Debug_FIFO_LENGTH;
            }
            else if(size & UART_Debug_TX_STS_FIFO_EMPTY)
            {
                size = 0u;
            }
            else
    ...
    *******************************************************************************/
    void UART_Debug_ClearTxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();        
        /* clear the HW FIFO */
        UART_Debug_TXDATA_AUX_CTL_REG |=  UART_Debug_TX_FIFO_CLR;
        UART_Debug_TXDATA_AUX_CTL_REG &= ~UART_Debug_TX_FIFO_CLR;
        /* Exit critical section */
        CyExitCriticalSection(enableInterrupts);
        ...
        if(UART_Debug_initVar != 0u)
        {
            ...
            uint8 tmpStat;
                    ...
                    (retMode == UART_Debug_SEND_WAIT_REINIT ) )
                {
                    ...
                    }while(tmpStat & UART_Debug_TX_STS_FIFO_EMPTY);
                }
                    ...
                    (retMode == UART_Debug_SEND_WAIT_REINIT) )
                {
                    ...
                    {
                        tmpStat = UART_Debug_TXSTATUS_REG;
                    }while(~tmpStat & UART_Debug_TX_STS_COMPLETE);
                }
                    ...
                    (retMode == UART_Debug_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_Debug_TXCLKGEN_DP)
                        tx_period = UART_Debug_TXBITCLKTX_COMPLETE_REG;
                        UART_Debug_TXBITCLKTX_COMPLETE_REG = UART_Debug_TXBITCTR_BREAKBITS;
                    #else
                        tx_period = UART_Debug_TXBITCTR_PERIOD_REG;
                    ...
                    (retMode == UART_Debug_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_Debug_TXCLKGEN_DP)
                        UART_Debug_TXBITCLKTX_COMPLETE_REG = tx_period;
                    #else
                        UART_Debug_TXBITCTR_PERIOD_REG = tx_period;
                    #endif /* End UART_Debug_TXCLKGEN_DP */
    ...
    *******************************************************************************/
    void UART_Debug_SetTxAddressMode(uint8 addressMode) 
    {
        ...
        if(addressMode != 0)
        {
            UART_Debug_WriteControlRegister(UART_Debug_ReadControlRegister() | UART_Debug_CTRL_MARK);
        }
        else
        {
            UART_Debug_WriteControlRegister(UART_Debug_ReadControlRegister() & ~UART_Debug_CTRL_MARK);
    ...
    *******************************************************************************/
    void UART_Debug_LoadTxConfig(void) 
    {
            ...
            UART_Debug_SetRxInterruptMode(0);
        #endif /* UART_Debug_RX_INTERRUPT_ENABLED */
