...
#if !defined(isr_PulseReadIR__REMOVED) /* Check for removal by optimization */
...
void isr_PulseReadIR_Start(void)
{
    ...
    /* Set the priority. */
    isr_PulseReadIR_SetPriority((uint8)isr_PulseReadIR_INTC_PRIOR_NUMBER);
...
*   before the component has been started use isr_PulseReadIR_StartEx instead.
*
* Parameters:
*   address: Address of the ISR to set in the interrupt vector table.
*
...
void isr_PulseReadIR_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_PulseReadIR__INTC_NUMBER] = address;
}
...
cyisraddress isr_PulseReadIR_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_PulseReadIR__INTC_NUMBER];
}
...
*   or isr_PulseReadIR_StartEx will override any effect this method 
*   would have had. This method should only be called after 
*   isr_PulseReadIR_Start or isr_PulseReadIR_StartEx has been called. To set 
...
uint8 isr_PulseReadIR_GetState(void)
{
    ...
    return ((*isr_PulseReadIR_INTC_SET_EN & (uint32)isr_PulseReadIR__INTC_MASK) != 0u) ? 1u:0u;
}
