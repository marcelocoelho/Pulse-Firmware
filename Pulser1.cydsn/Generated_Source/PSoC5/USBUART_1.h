...
#define USBUART_1_NUM_DEVICES   1
...
#define USBUART_1_MAX_REPORTID_NUMBER   0
...
typedef struct _USBUART_1_EpCtlBlock
{
    uint8  attrib;
    uint8  apiEpState;
    uint8  hwEpState;
...
typedef struct _USBUART_1_EpSettingsBlock
{
    uint8  interface;
    uint8  altSetting;
    uint8  addr;
...
typedef struct _USBUART_1_XferStatusBlock
{
    uint8  status;
    uint16 length;
} T_USBUART_1_XFER_STATUS_BLOCK;

typedef struct _USBUART_1_Td
{
    uint16  count;
...
typedef struct _USBUART_1_BackupStruct
{
    uint8 enableState;
    uint8 mode;
...
#define USBUART_1_EnableOutISOCEP(e)         USBUART_1_EnableOutEP(e)

#define USBUART_1_SetVector                  CyIntSetVector
#define USBUART_1_SetPriority                CyIntSetPriority
#define USBUART_1_EnableInt(a, b)            CyIntEnable(a)
...
#define USBUART_1_EPX_CNT0_MASK              (0x07u)
...
#define USBUART_1_ARB_INT_MASK              ((USBUART_1_DMA1_REMOVE ^ 1) | \
                                                    ...
                                                    (USBUART_1_DMA4_REMOVE ^ 1) << 3 | \
                                                    (USBUART_1_DMA5_REMOVE ^ 1) << 4 | \
                                                    (USBUART_1_DMA6_REMOVE ^ 1) << 5 | \
                                                    (USBUART_1_DMA7_REMOVE ^ 1) << 6 | \
                                                    (USBUART_1_DMA8_REMOVE ^ 1) << 7)
