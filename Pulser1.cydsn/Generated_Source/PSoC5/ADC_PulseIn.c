...
/* Valid only for PSoC5A silicon */
    ...
    static ADC_PulseIn_POWERMODE_BACKUP_STRUCT ADC_PulseIn_powerModeBackup = 
    {
        /* Initializing the structure fields with power mode registers of 
           config1 */
        ADC_PulseIn_CFG1_DSM_CR14,
        ADC_PulseIn_CFG1_DSM_CR15,
        ADC_PulseIn_CFG1_DSM_CR16,
        ADC_PulseIn_CFG1_DSM_CR17,
        ADC_PulseIn_CFG1_DSM_REF0,
        ADC_PulseIn_CFG1_DSM_BUF0,
        ADC_PulseIn_CFG1_DSM_BUF1,
...
/****************************************************************************** 
* Function Name: ADC_PulseIn_Init
*******************************************************************************
*
* Summary:
...
void ADC_PulseIn_Init(void) 
{
    ...
    ADC_PulseIn_GainCompensation(ADC_PulseIn_CFG1_RANGE, 
                                      ADC_PulseIn_CFG1_IDEAL_DEC_GAIN, 
                                      ADC_PulseIn_CFG1_IDEAL_ODDDEC_GAIN, 
                                      ADC_PulseIn_CFG1_RESOLUTION);        
}


/******************************************************************************
* Function Name: ADC_PulseIn_Enable
*******************************************************************************
*
* Summary: 
...
void ADC_PulseIn_Enable(void) 
{
    /* Restore the power registers if silicon used is PSoC5A */
        ...
        {
            ADC_PulseIn_RestorePowerRegisters();
    ...
    ***************************************************************************/
    void ADC_PulseIn_RestorePowerRegisters(void) 
    {
        ...
        ADC_PulseIn_DSM_CR16_REG = ADC_PulseIn_powerModeBackup.DSM_CR_16;
        ADC_PulseIn_DSM_CR17_REG = ADC_PulseIn_powerModeBackup.DSM_CR_17;
        ADC_PulseIn_DSM_REF0_REG = ADC_PulseIn_powerModeBackup.DSM_REF0;
        ADC_PulseIn_DSM_BUF0_REG = ADC_PulseIn_powerModeBackup.DSM_BUF0;
        ADC_PulseIn_DSM_BUF1_REG = ADC_PulseIn_powerModeBackup.DSM_BUF1;
        ADC_PulseIn_DSM_CLK_REG = ADC_PulseIn_powerModeBackup.DSM_CLK;
    }


    /************************************************************************** 
    * Function Name: ADC_PulseIn_SavePowerRegisters
    ***************************************************************************
    *
    * Summary: 
    ...
    **************************************************************************/
    void ADC_PulseIn_SavePowerRegisters(void) 
    {
        ...
        ADC_PulseIn_powerModeBackup.DSM_CR_16 = ADC_PulseIn_DSM_CR16_REG;
        ADC_PulseIn_powerModeBackup.DSM_CR_17 = ADC_PulseIn_DSM_CR17_REG;
        ADC_PulseIn_powerModeBackup.DSM_REF0 = ADC_PulseIn_DSM_REF0_REG;
        ADC_PulseIn_powerModeBackup.DSM_BUF0 = ADC_PulseIn_DSM_BUF0_REG;
        ADC_PulseIn_powerModeBackup.DSM_BUF1 = ADC_PulseIn_DSM_BUF1_REG;
        ADC_PulseIn_powerModeBackup.DSM_CLK = ADC_PulseIn_DSM_CLK_REG;
    }


    /************************************************************************* 
    * Function Name: ADC_PulseIn_SetLowPower
    ***************************************************************************
    *
    * Summary: 
    ...
    ***************************************************************************/
    void ADC_PulseIn_SetLowPower(void) 
    {
        ...
        ADC_PulseIn_DSM_CR15_REG &= ~(ADC_PulseIn_DSM_POWER2_3_MASK | ADC_PulseIn_DSM_POWER_COMP_MASK);
        ADC_PulseIn_DSM_CR15_REG |= (ADC_PulseIn_DSM_POWER2_3_LOW | ADC_PulseIn_DSM_POWER_VERYLOW);
        
        ADC_PulseIn_DSM_CR16_REG &= ~(ADC_PulseIn_DSM_CP_PWRCTL_MASK | ADC_PulseIn_DSM_POWER_SUM_MASK |
                                           ADC_PulseIn_DSM_CP_ENABLE);
        ADC_PulseIn_DSM_CR16_REG |= (ADC_PulseIn_DSM_POWER_SUM_LOW | ADC_PulseIn_DSM_CP_PWRCTL_LOW);
        
        ADC_PulseIn_DSM_CR17_REG &= ~(ADC_PulseIn_DSM_EN_BUF_VREF | ADC_PulseIn_DSM_PWR_CTRL_VCM_MASK |
                                           ADC_PulseIn_DSM_PWR_CTRL_VREF_MASK | ADC_PulseIn_DSM_EN_BUF_VCM |
                                           ADC_PulseIn_DSM_PWR_CTRL_VREF_INN_MASK);
        ADC_PulseIn_DSM_CR17_REG |= (ADC_PulseIn_DSM_PWR_CTRL_VREF_0 | ADC_PulseIn_DSM_PWR_CTRL_VCM_0 |
                                           ADC_PulseIn_DSM_PWR_CTRL_VREF_INN_0);
        
        /* Disable reference buffers */
        ADC_PulseIn_DSM_REF0_REG &= ~(ADC_PulseIn_DSM_EN_BUF_VREF_INN | ADC_PulseIn_DSM_VREF_RES_DIV_EN |
                                           ADC_PulseIn_DSM_VCM_RES_DIV_EN);
            
        /* Disable the positive input buffer */
        ADC_PulseIn_DSM_BUF0_REG &= ~ADC_PulseIn_DSM_ENABLE_P;
        /* Disable the negative input buffer */
        ADC_PulseIn_DSM_BUF1_REG &= ~ADC_PulseIn_DSM_ENABLE_N;
...
/******************************************************************************* 
* Function Name: ADC_PulseIn_Start
********************************************************************************
*
* Summary:
...
{
    if(ADC_PulseIn_initVar == 0u)
    {
        if(!(ADC_PulseIn_started))
        {
            ADC_PulseIn_Init();
        }
        ADC_PulseIn_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: ADC_PulseIn_Stop
********************************************************************************
*
* Summary:
...
void ADC_PulseIn_Stop(void) 
{
    ...
    ADC_PulseIn_DEC_SR_REG |=  ADC_PulseIn_DEC_INTR_CLEAR;
    ...
    /* If PSoC5A then don't disable the power instead put the block to  
       ...
       registers before putting block to low power mode */
        ...
        ADC_PulseIn_SavePowerRegisters();
        ADC_PulseIn_SetLowPower();
    #else    
...
/*******************************************************************************
* Function Name: ADC_PulseIn_SetBufferGain
********************************************************************************
*
* Summary:
...
{
    uint8 tmpReg;
    tmpReg = ADC_PulseIn_DSM_BUF1_REG & ~ADC_PulseIn_DSM_GAIN_MASK;
    tmpReg |= (gain << 2);
    ADC_PulseIn_DSM_BUF1_REG = tmpReg;
}


/*******************************************************************************
* Function Name: ADC_PulseIn_SetCoherency
********************************************************************************
*
* Summary:
...
{
    uint8 tmpReg;    
    tmpReg = ADC_PulseIn_DEC_COHER_REG & ~ADC_PulseIn_DEC_SAMP_KEY_MASK;
    tmpReg |= coherency;
    ADC_PulseIn_DEC_COHER_REG = tmpReg;
}


/*******************************************************************************
* Function Name: ADC_PulseIn_SetGCOR
********************************************************************************
*
* Summary:
...
uint8 ADC_PulseIn_SetGCOR(float gainAdjust) 
{
    ...
    tmpReg = ADC_PulseIn_DEC_GCORH_REG;
    tmpReg = (tmpReg << 8) | ADC_PulseIn_DEC_GCOR_REG;
    tmpValue = ((float)tmpReg / ADC_PulseIn_IDEAL_GAIN_CONST);
    ...
    {
        tmpReg = (uint16)(tmpValue * ADC_PulseIn_IDEAL_GAIN_CONST);
        ADC_PulseIn_DEC_GCOR_REG = (uint8)tmpReg;
        ADC_PulseIn_DEC_GCORH_REG = (uint8) (tmpReg >> 8);
        status = 0;
    }
...
/******************************************************************************
* Function Name: ADC_PulseIn_ReadGCOR
*******************************************************************************
*
* Summary:
...
uint16 ADC_PulseIn_ReadGCOR(void) 
{
    ...
    gValue = ADC_PulseIn_DEC_GVAL_REG;
    gcorRegValue = CY_GET_REG16(ADC_PulseIn_DEC_GCOR_PTR);
    
    switch (gValue)
    {
        case ADC_PulseIn_GVAL_RESOLUTIN_8:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
        
        case ADC_PulseIn_GVAL_RESOLUTIN_9:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
            
        case ADC_PulseIn_GVAL_RESOLUTIN_10:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
            
        case ADC_PulseIn_GVAL_RESOLUTIN_11:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
            
        case ADC_PulseIn_GVAL_RESOLUTIN_12:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
            
        case ADC_PulseIn_GVAL_RESOLUTIN_13:
            gcorValue = gcorRegValue << (ADC_PulseIn_MAX_GVAL - gValue);
            break;
...
/*******************************************************************************
* Function Name: ADC_PulseIn_SetBufferChop
********************************************************************************
*
* Summary:
...
void ADC_PulseIn_SetBufferChop(uint8 chopen, uint8 chopFreq) 
{
    if(chopen != 0u)
    {
        ADC_PulseIn_DSM_BUF2_REG = (ADC_PulseIn_DSM_BUF_FCHOP_MASK & chopFreq) | \
                                         ADC_PulseIn_DSM_BUF_CHOP_EN;
    }
    else
    {
        ADC_PulseIn_DSM_BUF2_REG = 0x00u;
    }
}


/*******************************************************************************
* Function Name: ADC_PulseIn_StartConvert
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_PulseIn_StopConvert
********************************************************************************
*
* Summary:
*  Starts ADC conversion using the given mode.
...
void ADC_PulseIn_StopConvert(void) 
{
    ...
    ADC_PulseIn_convDone = 1u;
}


/*******************************************************************************
* Function Name: ADC_PulseIn_IsEndConversion
********************************************************************************
*
* Summary:
...
uint8 ADC_PulseIn_IsEndConversion(uint8 wMode) 
{
    ...
    if(ADC_PulseIn_stopConversion == 1u)
    {
        do
        {
            status = ADC_PulseIn_convDone;
        } while((status != ADC_PulseIn_DEC_CONV_DONE) && (wMode == ADC_PulseIn_WAIT_FOR_RESULT));
    }
    else
    {
        do 
        {
            status = ADC_PulseIn_DEC_SR_REG & ADC_PulseIn_DEC_CONV_DONE;
        } while((status != ADC_PulseIn_DEC_CONV_DONE) && (wMode == ADC_PulseIn_WAIT_FOR_RESULT));
    }
    return(status);
}
...
/*******************************************************************************
* Function Name: ADC_PulseIn_GetResult8
********************************************************************************
*
* Summary:
...
{
     return( ADC_PulseIn_DEC_SAMP_REG );
}


/*******************************************************************************
* Function Name: ADC_PulseIn_GetResult16
********************************************************************************
*
* Summary:
...
int16 ADC_PulseIn_GetResult16(void) 
{
    ...
    #if (CY_PSOC3)
        result = ADC_PulseIn_DEC_SAMPM_REG ;
        result = (result << 8 ) | ADC_PulseIn_DEC_SAMP_REG;
    #else
        result = (CY_GET_REG16(ADC_PulseIn_DEC_SAMP_PTR));
    #endif /* CY_PSOC3 */
...
/*******************************************************************************
* Function Name: ADC_PulseIn_GetResult32
********************************************************************************
*
* Summary:
...
int32 ADC_PulseIn_GetResult32(void) 
{
    uint32 result;
        ...
        result = (int8) (0xff & ADC_PulseIn_DEC_SAMPH_REG); 
        result = (result << 8) | ADC_PulseIn_DEC_SAMPM_REG;
        result = (result << 8) | ADC_PulseIn_DEC_SAMP_REG;
    #else
        result = CY_GET_REG16(ADC_PulseIn_DEC_SAMPH_PTR);
        result = (result << 16) | (CY_GET_REG16(ADC_PulseIn_DEC_SAMP_PTR));
    #endif /* CY_PSOC3 */
...
/*******************************************************************************
* Function Name: ADC_PulseIn_SetOffset
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_PulseIn_Offset:  Modified to set the user provided offset. This 
*  variable is used for offset calibration purpose.
*  Affects the ADC_PulseIn_CountsTo_Volts, 
...
/*******************************************************************************
* Function Name: ADC_PulseIn_SetGain
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_PulseIn_CountsTo_mVolts
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ADC_PulseIn_CountsPerVolt:  used to convert ADC counts to mVolts.
...
int16 ADC_PulseIn_CountsTo_mVolts( int32 adcCounts) 
{
    ...
    mVolts = ((A * adcCounts) / ((int32)ADC_PulseIn_CountsPerVolt/B)) ;   
...
/*******************************************************************************
* Function Name: ADC_PulseIn_CountsTo_Volts
********************************************************************************
*
* Summary:
...
float ADC_PulseIn_CountsTo_Volts( int32 adcCounts) 
{
    ...
    Volts = (float)adcCounts / (float)ADC_PulseIn_CountsPerVolt;   
...
/*******************************************************************************
* Function Name: ADC_PulseIn_CountsTo_uVolts
********************************************************************************
*
* Summary:
...
* resolution.
*
* uVolts = ((A * adcCounts) / ((int32)ADC_PulseIn_CountsPerVolt/B)) ;   
*
*  Resolution       A           B
*   8 - 11      1,000,000         1
*  12 - 14        100,000        10
...
/*******************************************************************************
* Function Name: ADC_PulseIn_IRQ_Start(void)
********************************************************************************
*
* Summary:
...
void ADC_PulseIn_IRQ_Start(void) 
{
    ...
    CyIntDisable(ADC_PulseIn_IRQ__INTC_NUMBER );

    /* Set the ISR to point to the ADC_DelSig_1_IRQ Interrupt. */
    CyIntSetVector(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_ISR1);

    /* Set the priority. */
    CyIntSetPriority(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_IRQ_INTC_PRIOR_NUMBER);

    /* Enable interrupt. */
    CyIntEnable(ADC_PulseIn_IRQ__INTC_NUMBER);
}


/*******************************************************************************
* Function Name: ADC_PulseIn_InitConfig(uint8 config)
********************************************************************************
*
* Summary:
...
void ADC_PulseIn_InitConfig(uint8 config) 
{
    ...
    if(ADC_PulseIn_initVar == 0u)
        {
            ADC_PulseIn_DSM_DEM0_REG    = ADC_PulseIn_CFG1_DSM_DEM0;    
            ADC_PulseIn_DSM_DEM1_REG    = ADC_PulseIn_CFG1_DSM_DEM1;    
            ADC_PulseIn_DSM_MISC_REG    = ADC_PulseIn_CFG1_DSM_MISC;    
            ADC_PulseIn_DSM_CLK_REG    |= ADC_PulseIn_CFG1_DSM_CLK; 
            ADC_PulseIn_DSM_REF1_REG    = ADC_PulseIn_CFG1_DSM_REF1;    
        
            ADC_PulseIn_DSM_OUT0_REG    = ADC_PulseIn_CFG1_DSM_OUT0;    
            ADC_PulseIn_DSM_OUT1_REG    = ADC_PulseIn_CFG1_DSM_OUT1;   
        
            ADC_PulseIn_DSM_CR0_REG     = ADC_PulseIn_CFG1_DSM_CR0;     
            ADC_PulseIn_DSM_CR1_REG     = ADC_PulseIn_CFG1_DSM_CR1;     
            ADC_PulseIn_DSM_CR2_REG     = ADC_PulseIn_CFG1_DSM_CR2;     
            ADC_PulseIn_DSM_CR3_REG     = ADC_PulseIn_CFG1_DSM_CR3;     
            ADC_PulseIn_DSM_CR13_REG    = ADC_PulseIn_CFG1_DSM_CR13;     
            
            ADC_PulseIn_DEC_SR_REG      = ADC_PulseIn_CFG1_DEC_SR;      
            ADC_PulseIn_DEC_COHER_REG   = ADC_PulseIn_CFG1_DEC_COHER;   
        }

    if (config == 1u)
    {
        /* Default Config */   
        ADC_PulseIn_DEC_CR_REG      = ADC_PulseIn_CFG1_DEC_CR;      
        ADC_PulseIn_DEC_SHIFT1_REG  = ADC_PulseIn_CFG1_DEC_SHIFT1;  
        ADC_PulseIn_DEC_SHIFT2_REG  = ADC_PulseIn_CFG1_DEC_SHIFT2;  
        ADC_PulseIn_DEC_DR2_REG     = ADC_PulseIn_CFG1_DEC_DR2;     
        ADC_PulseIn_DEC_DR2H_REG    = ADC_PulseIn_CFG1_DEC_DR2H;    
        ADC_PulseIn_DEC_DR1_REG     = ADC_PulseIn_CFG1_DEC_DR1;     
        ADC_PulseIn_DEC_OCOR_REG    = ADC_PulseIn_CFG1_DEC_OCOR;    
        ADC_PulseIn_DEC_OCORM_REG   = ADC_PulseIn_CFG1_DEC_OCORM;   
        ADC_PulseIn_DEC_OCORH_REG   = ADC_PulseIn_CFG1_DEC_OCORH;   
        
        ADC_PulseIn_DSM_CR4_REG     = ADC_PulseIn_CFG1_DSM_CR4;     
        ADC_PulseIn_DSM_CR5_REG     = ADC_PulseIn_CFG1_DSM_CR5;     
        ADC_PulseIn_DSM_CR6_REG     = ADC_PulseIn_CFG1_DSM_CR6;     
        ADC_PulseIn_DSM_CR7_REG     = ADC_PulseIn_CFG1_DSM_CR7;     
        ADC_PulseIn_DSM_CR8_REG     = ADC_PulseIn_CFG1_DSM_CR8;     
        ADC_PulseIn_DSM_CR9_REG     = ADC_PulseIn_CFG1_DSM_CR9;     
        ADC_PulseIn_DSM_CR10_REG    = ADC_PulseIn_CFG1_DSM_CR10;    
        ADC_PulseIn_DSM_CR11_REG    = ADC_PulseIn_CFG1_DSM_CR11;    
        ADC_PulseIn_DSM_CR12_REG    = ADC_PulseIn_CFG1_DSM_CR12;    
        ...
        ADC_PulseIn_DSM_BUF0_REG    = ADC_PulseIn_CFG1_DSM_BUF0;    
        ...
        */
        ...
        #if(ADC_PulseIn_CFG1_RESOLUTION > 16 && \
            ADC_PulseIn_CFG1_CONV_MODE == ADC_PulseIn_MODE_SINGLE_SAMPLE) 
            ADC_PulseIn_stopConversion = 1;
        #endif /* Single sample with resolution above 16 bits. */
        ADC_PulseIn_CountsPerVolt = (uint32)ADC_PulseIn_CFG1_COUNTS_PER_VOLT;
        ...
        {
            /* Second Config */
            ADC_PulseIn_DEC_CR_REG      = ADC_PulseIn_CFG2_DEC_CR;      
            ADC_PulseIn_DEC_SHIFT1_REG  = ADC_PulseIn_CFG2_DEC_SHIFT1;  
            ADC_PulseIn_DEC_SHIFT2_REG  = ADC_PulseIn_CFG2_DEC_SHIFT2;  
            ADC_PulseIn_DEC_DR2_REG     = ADC_PulseIn_CFG2_DEC_DR2;     
            ADC_PulseIn_DEC_DR2H_REG    = ADC_PulseIn_CFG2_DEC_DR2H;    
            ADC_PulseIn_DEC_DR1_REG     = ADC_PulseIn_CFG2_DEC_DR1;     
            ADC_PulseIn_DEC_OCOR_REG    = ADC_PulseIn_CFG2_DEC_OCOR;    
            ADC_PulseIn_DEC_OCORM_REG   = ADC_PulseIn_CFG2_DEC_OCORM;   
            ADC_PulseIn_DEC_OCORH_REG   = ADC_PulseIn_CFG2_DEC_OCORH;   
        
            ADC_PulseIn_DSM_CR4_REG     = ADC_PulseIn_CFG2_DSM_CR4;     
            ADC_PulseIn_DSM_CR5_REG     = ADC_PulseIn_CFG2_DSM_CR5;     
            ADC_PulseIn_DSM_CR6_REG     = ADC_PulseIn_CFG2_DSM_CR6;     
            ADC_PulseIn_DSM_CR7_REG     = ADC_PulseIn_CFG2_DSM_CR7;     
            ADC_PulseIn_DSM_CR8_REG     = ADC_PulseIn_CFG2_DSM_CR8;     
            ADC_PulseIn_DSM_CR9_REG     = ADC_PulseIn_CFG2_DSM_CR9;     
            ADC_PulseIn_DSM_CR10_REG    = ADC_PulseIn_CFG2_DSM_CR10;    
            ADC_PulseIn_DSM_CR11_REG    = ADC_PulseIn_CFG2_DSM_CR11;    
            ADC_PulseIn_DSM_CR12_REG    = ADC_PulseIn_CFG2_DSM_CR12;    
            ADC_PulseIn_DSM_CR14_REG    = ADC_PulseIn_CFG2_DSM_CR14;    
            ...
            ADC_PulseIn_DSM_BUF0_REG    = ADC_PulseIn_CFG2_DSM_BUF0;    
            ...
            */
            ...
            #if(ADC_PulseIn_CFG2_RESOLUTION > 16 && \
                ADC_PulseIn_CFG2_CONVMODE == ADC_PulseIn_MODE_SINGLE_SAMPLE) 
                ADC_PulseIn_stopConversion = 1;
            #endif /* Single sample with resolution above 16 bits. */
            
            ADC_PulseIn_CountsPerVolt = (uint32)ADC_PulseIn_CFG2_COUNTS_PER_VOLT;
            
            /* Start and set interrupt vector */
            CyIntSetPriority(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_IRQ_INTC_PRIOR_NUMBER);
            CyIntSetVector(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_ISR2 );
            CyIntEnable(ADC_PulseIn_IRQ__INTC_NUMBER);
        }
    #endif /* ADC_PulseIn_DEFAULT_NUM_CONFIGS > 1 */

    #if(ADC_PulseIn_DEFAULT_NUM_CONFIGS > 2)
        if(config == 3u)
        {
            /* Third Config */
            ADC_PulseIn_DEC_CR_REG      = ADC_PulseIn_CFG3_DEC_CR;      
            ADC_PulseIn_DEC_SHIFT1_REG  = ADC_PulseIn_CFG3_DEC_SHIFT1;  
            ADC_PulseIn_DEC_SHIFT2_REG  = ADC_PulseIn_CFG3_DEC_SHIFT2;  
            ADC_PulseIn_DEC_DR2_REG     = ADC_PulseIn_CFG3_DEC_DR2;     
            ADC_PulseIn_DEC_DR2H_REG    = ADC_PulseIn_CFG3_DEC_DR2H;    
            ADC_PulseIn_DEC_DR1_REG     = ADC_PulseIn_CFG3_DEC_DR1;     
            ADC_PulseIn_DEC_OCOR_REG    = ADC_PulseIn_CFG3_DEC_OCOR;    
            ADC_PulseIn_DEC_OCORM_REG   = ADC_PulseIn_CFG3_DEC_OCORM;   
            ADC_PulseIn_DEC_OCORH_REG   = ADC_PulseIn_CFG3_DEC_OCORH;   
         
            ADC_PulseIn_DSM_CR4_REG     = ADC_PulseIn_CFG3_DSM_CR4;     
            ADC_PulseIn_DSM_CR5_REG     = ADC_PulseIn_CFG3_DSM_CR5;     
            ADC_PulseIn_DSM_CR6_REG     = ADC_PulseIn_CFG3_DSM_CR6;     
            ADC_PulseIn_DSM_CR7_REG     = ADC_PulseIn_CFG3_DSM_CR7;     
            ADC_PulseIn_DSM_CR8_REG     = ADC_PulseIn_CFG3_DSM_CR8;     
            ADC_PulseIn_DSM_CR9_REG     = ADC_PulseIn_CFG3_DSM_CR9;     
            ADC_PulseIn_DSM_CR10_REG    = ADC_PulseIn_CFG3_DSM_CR10;    
            ADC_PulseIn_DSM_CR11_REG    = ADC_PulseIn_CFG3_DSM_CR11;    
            ADC_PulseIn_DSM_CR12_REG    = ADC_PulseIn_CFG3_DSM_CR12;    
            ADC_PulseIn_DSM_CR14_REG    = ADC_PulseIn_CFG3_DSM_CR14;    
            ...
            ADC_PulseIn_DSM_BUF0_REG    = ADC_PulseIn_CFG3_DSM_BUF0;    
            ...
            */
            ...
            /* Set the Conversion stop if resolution is above 16 bit and 
               conversion  mode is Single sample */
            #if(ADC_PulseIn_CFG3_RESOLUTION > 16 && \
                ADC_PulseIn_CFG3_CONVMODE == ADC_PulseIn_MODE_SINGLE_SAMPLE) 
                ADC_PulseIn_stopConversion = 1;
            #endif /* Single sample with resolution above 16 bits */
            
            ADC_PulseIn_CountsPerVolt = (uint32)ADC_PulseIn_CFG3_COUNTS_PER_VOLT;
            
            /* Start and set interrupt vector */
            CyIntSetPriority(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_IRQ_INTC_PRIOR_NUMBER);
            CyIntSetVector(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_ISR3 );
            CyIntEnable(ADC_PulseIn_IRQ__INTC_NUMBER);
        }
    #endif /* ADC_PulseIn_DEFAULT_NUM_CONFIGS > 3 */

    #if(ADC_PulseIn_DEFAULT_NUM_CONFIGS == 4)
        if (config == 4u)
        {
            /* Fourth Config */
            ADC_PulseIn_DEC_CR_REG      = ADC_PulseIn_CFG4_DEC_CR;      
            ADC_PulseIn_DEC_SHIFT1_REG  = ADC_PulseIn_CFG4_DEC_SHIFT1;  
            ADC_PulseIn_DEC_SHIFT2_REG  = ADC_PulseIn_CFG4_DEC_SHIFT2;  
            ADC_PulseIn_DEC_DR2_REG     = ADC_PulseIn_CFG4_DEC_DR2;     
            ADC_PulseIn_DEC_DR2H_REG    = ADC_PulseIn_CFG4_DEC_DR2H;    
            ADC_PulseIn_DEC_DR1_REG     = ADC_PulseIn_CFG4_DEC_DR1;     
            ADC_PulseIn_DEC_OCOR_REG    = ADC_PulseIn_CFG4_DEC_OCOR;    
            ADC_PulseIn_DEC_OCORM_REG   = ADC_PulseIn_CFG4_DEC_OCORM;   
            ADC_PulseIn_DEC_OCORH_REG   = ADC_PulseIn_CFG4_DEC_OCORH;   

            ADC_PulseIn_DSM_CR4_REG     = ADC_PulseIn_CFG4_DSM_CR4;     
            ADC_PulseIn_DSM_CR5_REG     = ADC_PulseIn_CFG4_DSM_CR5;     
            ADC_PulseIn_DSM_CR6_REG     = ADC_PulseIn_CFG4_DSM_CR6;     
            ADC_PulseIn_DSM_CR7_REG     = ADC_PulseIn_CFG4_DSM_CR7;     
            ADC_PulseIn_DSM_CR8_REG     = ADC_PulseIn_CFG4_DSM_CR8;     
            ADC_PulseIn_DSM_CR9_REG     = ADC_PulseIn_CFG4_DSM_CR9;     
            ADC_PulseIn_DSM_CR10_REG    = ADC_PulseIn_CFG4_DSM_CR10;    
            ADC_PulseIn_DSM_CR11_REG    = ADC_PulseIn_CFG4_DSM_CR11;    
            ADC_PulseIn_DSM_CR12_REG    = ADC_PulseIn_CFG4_DSM_CR12;    
            ...
            ADC_PulseIn_DSM_BUF0_REG    = ADC_PulseIn_CFG4_DSM_BUF0;    
            ...
            */
            ...
            /* Set the Conversion stop if resolution is above 16 bit and 
               conversion mode is Single sample */
            #if(ADC_PulseIn_CFG4_RESOLUTION > 16 && \
                ADC_PulseIn_CFG4_CONVMODE == ADC_PulseIn_MODE_SINGLE_SAMPLE) 
                ADC_PulseIn_stopConversion = 1;
            #endif /* Single sample with resolution above 16 bits */
            
            ADC_PulseIn_CountsPerVolt = (uint32)ADC_PulseIn_CFG4_COUNTS_PER_VOLT;

            /* Start and set interrupt vector */
            CyIntSetPriority(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_IRQ_INTC_PRIOR_NUMBER);
            CyIntSetVector(ADC_PulseIn_IRQ__INTC_NUMBER, ADC_PulseIn_ISR4 );
            CyIntEnable(ADC_PulseIn_IRQ__INTC_NUMBER);
        }
    #endif /* ADC_PulseIn_DEFAULT_NUM_CONFIGS > 4 */
}


/*******************************************************************************
* Function Name: ADC_PulseIn_RoundValue(uint32 busClockFreq, 
*                                            uint32 clockFreq)
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_PulseIn_SelectCofiguration(uint8 config, 
*                                                    uint8 restart)
********************************************************************************
*
* Summary:
                                              ...
                                              
{
    ...
    if( config <= ADC_PulseIn_DEFAULT_NUM_CONFIGS)
    {   
       /* Set the flag to ensure start() API dont override the config
        ...
        if(config == 1u)
        {
            inputRange = ADC_PulseIn_CFG1_RANGE;
            resolution = ADC_PulseIn_CFG1_RESOLUTION;
            ...
            if(config == 2u)
            {
                inputRange = ADC_PulseIn_CFG2_INPUT_RANGE;
                resolution = ADC_PulseIn_CFG2_RESOLUTION;
            ...
            if(config == 3u)
            {
                inputRange = ADC_PulseIn_CFG3_INPUT_RANGE;
                resolution = ADC_PulseIn_CFG3_RESOLUTION;
        ...
        #if (ADC_PulseIn_DEFAULT_NUM_CONFIGS > 3)
            if(config == 4u)
            {
                inputRange = ADC_PulseIn_CFG4_INPUT_RANGE;
                resolution = ADC_PulseIn_CFG4_RESOLUTION;
        ...
        {        
            ...
            #if (((ADC_PulseIn_CFG2_REFERENCE == ADC_PulseIn_EXT_REF_ON_P03) || \
                 (ADC_PulseIn_CFG2_REFERENCE == ADC_PulseIn_EXT_REF_ON_P32)) || \
                 ((ADC_PulseIn_CFG3_REFERENCE == ADC_PulseIn_EXT_REF_ON_P03) || \
                 (ADC_PulseIn_CFG3_REFERENCE == ADC_PulseIn_EXT_REF_ON_P32)) || \
                 ((ADC_PulseIn_CFG4_REFERENCE == ADC_PulseIn_EXT_REF_ON_P03) || \
                 (ADC_PulseIn_CFG4_REFERENCE == ADC_PulseIn_EXT_REF_ON_P32)))
                if (((config == 2) && 
                    ((ADC_PulseIn_CFG2_REFERENCE == ADC_PulseIn_EXT_REF_ON_P03) ||
                    (ADC_PulseIn_CFG2_REFERENCE == ADC_PulseIn_EXT_REF_ON_P32))) ||
                    ((config == 3) && 
                    ((ADC_PulseIn_CFG3_REFERENCE == ADC_PulseIn_EXT_REF_ON_P03) ||
                    (ADC_PulseIn_CFG3_REFERENCE == ADC_PulseIn_EXT_REF_ON_P32))) ||
...
/*******************************************************************************
* Function Name: ADC_PulseIn_GainCompensation(uint8, uint16, uint16, uint8)
********************************************************************************
*
* Summary:
                                       ...
                                       uint8 resolution) 
{
    ...
    switch(inputRange)
    {         
        case ADC_PulseIn_IR_VNEG_VREF_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_DIFF_16_20; 
        }    
        else
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_DIFF_8_15;
        }        
        break;
        
        case ADC_PulseIn_IR_VNEG_VREF_2_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_2_DIFF_16_20;
        }    
        else
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_2_DIFF_8_15;
        }    
        break;
        
        case ADC_PulseIn_IR_VNEG_VREF_4_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_4_DIFF_16_20;
        }    
        else
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_4_DIFF_8_15;
        }    
        break;
        
        case ADC_PulseIn_IR_VNEG_VREF_16_DIFF:
        
        /* Normalize the flash Value */
        if(resolution > 15)
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_16_DIFF_16_20;
        }    
        else
        {
            flash = ADC_PulseIn_DEC_TRIM_VREF_16_DIFF_8_15;
        }    
        break;
    ...
    if(inputRange == ADC_PulseIn_IR_VSSA_TO_VREF || inputRange == ADC_PulseIn_IR_VSSA_TO_2VREF || 
       inputRange == ADC_PulseIn_IR_VSSA_TO_VDDA || inputRange == ADC_PulseIn_IR_VSSA_TO_6VREF || 
       inputRange == ADC_PulseIn_IR_VNEG_2VREF_DIFF || inputRange == ADC_PulseIn_IR_VNEG_6VREF_DIFF ||
       inputRange == ADC_PulseIn_IR_VNEG_VREF_8_DIFF)
    {
        Normalised  = 0;
    }
    else
    ...
    GcorValue = (uint16)(GcorTmp / ADC_PulseIn_IDEAL_GAIN_CONST);
        
    if (resolution < 14)
    {
        GcorValue = (GcorValue >> (15 - (resolution + 1)));
        ADC_PulseIn_DEC_GVAL_REG = (resolution + 1);
    }
    else
    {
        /* Use all 16 bits */
        ADC_PulseIn_DEC_GVAL_REG = 15u;  
    }
