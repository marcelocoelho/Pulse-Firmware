...
typedef struct _PrISM_LEDCool_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_LEDCool_AUX_CONTROL2_PTR   ((reg32 *) PrISM_LEDCool_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_LEDCool_AUX_CONTROL2_PTR   ((reg32 *) PrISM_LEDCool_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
