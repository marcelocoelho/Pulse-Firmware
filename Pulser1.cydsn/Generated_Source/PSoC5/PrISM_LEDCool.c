...
void PrISM_LEDCool_Init(void) 
{
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        #if(PrISM_LEDCool_GREATERTHAN_OR_EQUAL == PrISM_LEDCool_COMPARE0)
            PrISM_LEDCool_CONTROL_REG |= PrISM_LEDCool_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_LEDCool_CONTROL_REG &= (uint8)~PrISM_LEDCool_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_LEDCool_COMPARE0 */    
    
        #if(PrISM_LEDCool_GREATERTHAN_OR_EQUAL == PrISM_LEDCool_COMPARE1)
            PrISM_LEDCool_CONTROL_REG |= PrISM_LEDCool_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_LEDCool_CONTROL_REG &= (uint8)~PrISM_LEDCool_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_LEDCool_COMPARE1 */    
...
{
    #if(!PrISM_LEDCool_PULSE_TYPE_HARDCODED)
        PrISM_LEDCool_CONTROL_REG &= (uint8)~PrISM_LEDCool_CTRL_ENABLE;
    #else
