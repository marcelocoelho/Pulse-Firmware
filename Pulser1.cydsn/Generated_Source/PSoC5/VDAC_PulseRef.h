...
extern uint8 VDAC_PulseRef_initVar;
...
*              Registers        
***************************************/
#define VDAC_PulseRef_CR0_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__CR0 )
#define VDAC_PulseRef_CR0_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__CR0 )
#define VDAC_PulseRef_CR1_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__CR1 )
#define VDAC_PulseRef_CR1_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__CR1 )
#define VDAC_PulseRef_Data_REG           (* (reg8 *) VDAC_PulseRef_viDAC8__D )
#define VDAC_PulseRef_Data_PTR           (  (reg8 *) VDAC_PulseRef_viDAC8__D )
#define VDAC_PulseRef_Strobe_REG         (* (reg8 *) VDAC_PulseRef_viDAC8__STROBE )
#define VDAC_PulseRef_Strobe_PTR         (  (reg8 *) VDAC_PulseRef_viDAC8__STROBE )
#define VDAC_PulseRef_SW0_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__SW0 )
#define VDAC_PulseRef_SW0_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__SW0 )
#define VDAC_PulseRef_SW2_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__SW2 )
#define VDAC_PulseRef_SW2_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__SW2 )
#define VDAC_PulseRef_SW3_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__SW3 )
#define VDAC_PulseRef_SW3_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__SW3 )
#define VDAC_PulseRef_SW4_REG            (* (reg8 *) VDAC_PulseRef_viDAC8__SW4 )
#define VDAC_PulseRef_SW4_PTR            (  (reg8 *) VDAC_PulseRef_viDAC8__SW4 )
#define VDAC_PulseRef_TR_REG             (* (reg8 *) VDAC_PulseRef_viDAC8__TR )
#define VDAC_PulseRef_TR_PTR             (  (reg8 *) VDAC_PulseRef_viDAC8__TR )
/* Power manager */
#define VDAC_PulseRef_PWRMGR_REG         (* (reg8 *) VDAC_PulseRef_viDAC8__PM_ACT_CFG )
#define VDAC_PulseRef_PWRMGR_PTR         (  (reg8 *) VDAC_PulseRef_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC_PulseRef_STBY_PWRMGR_REG    (* (reg8 *) VDAC_PulseRef_viDAC8__PM_STBY_CFG )
#define VDAC_PulseRef_STBY_PWRMGR_PTR    (  (reg8 *) VDAC_PulseRef_viDAC8__PM_STBY_CFG )
