...
#if !defined(CY_CAPSENSE_CSD_AMUX_CapSense_1_AMuxCH0_H)
#define CY_CAPSENSE_CSD_AMUX_CapSense_1_AMuxCH0_H
...
#define CapSense_1_AMuxCH0_NULL_CHANNEL   (0xFFu)
#define CapSense_1_AMuxCH0_MUX_SINGLE     (1u)
#define CapSense_1_AMuxCH0_MUX_DIFF       (2u)
