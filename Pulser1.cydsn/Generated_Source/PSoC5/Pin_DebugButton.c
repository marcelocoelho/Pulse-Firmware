...
#if !(CY_PSOC5A &&\
	 Pin_DebugButton__PORT == 15 && ((Pin_DebugButton__MASK & 0xC0) != 0))
...
{
    uint8 staticBits = (Pin_DebugButton_DR & (uint8)(~Pin_DebugButton_MASK));
    Pin_DebugButton_DR = staticBits | ((uint8)(value << Pin_DebugButton_SHIFT) & Pin_DebugButton_MASK);
}
