...
{
    uint8 staticBits = (Pin_BrightLEDBlue_DR & (uint8)(~Pin_BrightLEDBlue_MASK));
    Pin_BrightLEDBlue_DR = staticBits | ((uint8)(value << Pin_BrightLEDBlue_SHIFT) & Pin_BrightLEDBlue_MASK);
}
