...
{
    uint8 staticBits = (Pin_Rx_Net_Enable_DR & (uint8)(~Pin_Rx_Net_Enable_MASK));
    Pin_Rx_Net_Enable_DR = staticBits | ((uint8)(value << Pin_Rx_Net_Enable_SHIFT) & Pin_Rx_Net_Enable_MASK);
}
