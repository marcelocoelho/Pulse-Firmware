...
#if !defined(CY_FILTER_Filter_1_PVT_H) /* FILT Header File */
...
extern const uint8 CYCODE Filter_1_control[]; 
extern const uint8 CYCODE Filter_1_data_a[];
extern const uint8 CYCODE Filter_1_data_b[];
extern const uint8 CYCODE Filter_1_cfsm[];
extern const uint8 CYCODE Filter_1_acu[];
...
/* Parameters */
#define Filter_1_INIT_INTERRUPT_MODE    (0u)
...
#define Filter_1_DA_RAM_SIZE            (0x200u)
#define Filter_1_DB_RAM_SIZE            (0x200u)
#define Filter_1_CSA_RAM_SIZE           (0x100u)
#define Filter_1_CSB_RAM_SIZE           (0x100u)
#define Filter_1_CFSM_RAM_SIZE          (0x100u)
#define Filter_1_ACU_RAM_SIZE           (0x040u)
