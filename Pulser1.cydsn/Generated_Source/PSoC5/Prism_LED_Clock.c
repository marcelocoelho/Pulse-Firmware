...
{
    if (Prism_LED_Clock_CLKEN & Prism_LED_Clock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Prism_LED_Clock_SetModeRegister(uint8 clkMode) 
{
    Prism_LED_Clock_MOD_SRC |= clkMode & Prism_LED_Clock_MODE_MASK;
}
...
*
*******************************************************************************/
void Prism_LED_Clock_ClearModeRegister(uint8 clkMode) 
{
    Prism_LED_Clock_MOD_SRC &= ~clkMode | ~Prism_LED_Clock_MODE_MASK;
}
...
{
    return Prism_LED_Clock_MOD_SRC & Prism_LED_Clock_MODE_MASK;
}
...
void Prism_LED_Clock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Prism_LED_Clock_MOD_SRC =
            (Prism_LED_Clock_MOD_SRC & ~Prism_LED_Clock_SRC_SEL_MSK) | clkSource;
    }
