...
{
    if (CapSense_1_IntClock_CLKEN & CapSense_1_IntClock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void CapSense_1_IntClock_SetModeRegister(uint8 clkMode) 
{
    CapSense_1_IntClock_MOD_SRC |= clkMode & CapSense_1_IntClock_MODE_MASK;
}
...
*
*******************************************************************************/
void CapSense_1_IntClock_ClearModeRegister(uint8 clkMode) 
{
    CapSense_1_IntClock_MOD_SRC &= ~clkMode | ~CapSense_1_IntClock_MODE_MASK;
}
...
{
    return CapSense_1_IntClock_MOD_SRC & CapSense_1_IntClock_MODE_MASK;
}
...
void CapSense_1_IntClock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        CapSense_1_IntClock_MOD_SRC =
            (CapSense_1_IntClock_MOD_SRC & ~CapSense_1_IntClock_SRC_SEL_MSK) | clkSource;
    }
