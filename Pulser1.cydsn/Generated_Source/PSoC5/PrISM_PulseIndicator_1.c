...
uint8 PrISM_PulseIndicator_1_initVar = 0u;


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The PrISM_PulseIndicator_1_initVar variable is used to indicate initial
*  configuration of this component.  The variable is initialized to zero and
*  set to 1 the first time PrISM_PulseIndicator_1_Start() is called. This allows for
*  component initialization without re-initialization in all subsequent calls
*  to the PrISM_PulseIndicator_1_Start() routine. 
...
void PrISM_PulseIndicator_1_Start(void) 
{
    ...
    if(PrISM_PulseIndicator_1_initVar == 0u)
    {
        PrISM_PulseIndicator_1_Init();
        PrISM_PulseIndicator_1_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: PrISM_PulseIndicator_1_Init
********************************************************************************
*
* Summary:
*  Initialize component's parameters to the parameters set by user in the 
*  customizer of the component placed onto schematic. Usually called in 
*  PrISM_PulseIndicator_1_Start().
*
* Parameters:  
*  None.
*
...
void PrISM_PulseIndicator_1_Init(void) 
{
    ...
    PrISM_PulseIndicator_1_WriteSeed(PrISM_PulseIndicator_1_SEED);
    PrISM_PulseIndicator_1_WritePolynomial(PrISM_PulseIndicator_1_POLYNOM);
    PrISM_PulseIndicator_1_WritePulse0(PrISM_PulseIndicator_1_DENSITY0);
    PrISM_PulseIndicator_1_WritePulse1(PrISM_PulseIndicator_1_DENSITY1);
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        if(PrISM_PulseIndicator_1_GREATERTHAN_OR_EQUAL == 0 )
        {
            PrISM_PulseIndicator_1_CONTROL_REG |= PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_PulseIndicator_1_CONTROL_REG &= ~PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        ...
        if(PrISM_PulseIndicator_1_GREATERTHAN_OR_EQUAL == 0)
        {
            PrISM_PulseIndicator_1_CONTROL_REG |= PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_PulseIndicator_1_CONTROL_REG &= ~PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
...
/*******************************************************************************
* Function Name: PrISM_PulseIndicator_1_Enable
********************************************************************************
*  
* Summary: 
...
void PrISM_PulseIndicator_1_Enable(void) 
{
        ...
        PrISM_PulseIndicator_1_CONTROL_REG |= PrISM_PulseIndicator_1_CTRL_ENABLE;
    #endif /* End PrISM_PulseIndicator_1_PULSE_TYPE_HARDCODED */
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_Stop
********************************************************************************
*
* Summary:
...
void PrISM_PulseIndicator_1_Stop(void) 
{
    ...
    /***************************************************************************
    * FUNCTION NAME:     PrISM_PulseIndicator_1_SetPulse0Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse0Type == PrISM_PulseIndicator_1_GREATERTHAN_OR_EQUAL)
        {
            PrISM_PulseIndicator_1_CONTROL_REG |= PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
    ...
    /***************************************************************************
    * FUNCTION NAME:   PrISM_PulseIndicator_1_SetPulse1Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse1Type == PrISM_PulseIndicator_1_GREATERTHAN_OR_EQUAL)
        {
            PrISM_PulseIndicator_1_CONTROL_REG |= PrISM_PulseIndicator_1_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
...
#endif /* End PrISM_PulseIndicator_1_PULSE_TYPE_HARDCODED == 0 */


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_ReadSeed
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_1_SEED_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_WriteSeed
********************************************************************************
*
* Summary:
...
void PrISM_PulseIndicator_1_WriteSeed(uint8 seed) 
{
    if(seed != 0u)
    {
        CY_SET_REG8(PrISM_PulseIndicator_1_SEED_COPY_PTR, seed);
        CY_SET_REG8(PrISM_PulseIndicator_1_SEED_PTR, seed);
    }
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_ReadPolynomial
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_1_POLYNOM_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_WritePolynomial
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_1_POLYNOM_PTR, polynomial);
    
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_ReadPulse0
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_1_DENSITY0_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_WritePulse0
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_1_DENSITY0_PTR, pulseDensity0);
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_ReadPulse1
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_1_DENSITY1_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_1_WritePulse1
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_1_DENSITY1_PTR, pulseDensity1);
}
