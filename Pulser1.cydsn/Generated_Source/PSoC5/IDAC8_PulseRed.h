...
extern uint8 IDAC8_PulseRed_initVar;
...
#define IDAC8_PulseRed_DEFAULT_SPEED     ((uint8)(((0u != 0u) ? 1u : 0u) << 1u))   /* Default DAC speed */
...
*              Registers        
***************************************/
#define IDAC8_PulseRed_CR0_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__CR0 )
#define IDAC8_PulseRed_CR0_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__CR0 )
#define IDAC8_PulseRed_CR1_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__CR1 )
#define IDAC8_PulseRed_CR1_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__CR1 )
#define IDAC8_PulseRed_Data_REG        (* (reg8 *) IDAC8_PulseRed_viDAC8__D )
#define IDAC8_PulseRed_Data_PTR        (  (reg8 *) IDAC8_PulseRed_viDAC8__D )
#define IDAC8_PulseRed_Strobe_REG      (* (reg8 *) IDAC8_PulseRed_viDAC8__STROBE )
#define IDAC8_PulseRed_Strobe_PTR      (  (reg8 *) IDAC8_PulseRed_viDAC8__STROBE )
#define IDAC8_PulseRed_SW0_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__SW0 )
#define IDAC8_PulseRed_SW0_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__SW0 )
#define IDAC8_PulseRed_SW2_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__SW2 )
#define IDAC8_PulseRed_SW2_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__SW2 )
#define IDAC8_PulseRed_SW3_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__SW3 )
#define IDAC8_PulseRed_SW3_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__SW3 )
#define IDAC8_PulseRed_SW4_REG         (* (reg8 *) IDAC8_PulseRed_viDAC8__SW4 )
#define IDAC8_PulseRed_SW4_PTR         (  (reg8 *) IDAC8_PulseRed_viDAC8__SW4 )
#define IDAC8_PulseRed_TR_REG          (* (reg8 *) IDAC8_PulseRed_viDAC8__TR )
#define IDAC8_PulseRed_TR_PTR          (  (reg8 *) IDAC8_PulseRed_viDAC8__TR )
#define IDAC8_PulseRed_PWRMGR_REG      (* (reg8 *) IDAC8_PulseRed_viDAC8__PM_ACT_CFG )  /* Power manager */
#define IDAC8_PulseRed_PWRMGR_PTR      (  (reg8 *) IDAC8_PulseRed_viDAC8__PM_ACT_CFG )  /* Power manager */
#define IDAC8_PulseRed_STBY_PWRMGR_REG (* (reg8 *) IDAC8_PulseRed_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
#define IDAC8_PulseRed_STBY_PWRMGR_PTR (  (reg8 *) IDAC8_PulseRed_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
