...
***************************************/
static void ADC_SAR_ProxIR_CalcGain(uint8 resolution);


/***************************************
* Global data allocation
***************************************/
uint8 ADC_SAR_ProxIR_initVar = 0u;
...
***************************************/
#if(CY_PSOC5A)
    static uint8 ADC_SAR_ProxIR_resolution;
#endif /* End CY_PSOC5A */


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The ADC_SAR_ProxIR_initVar variable is used to indicate when/if initial
*  configuration of this component has happened. The variable is initialized to
*  zero and set to 1 the first time ADC_Start() is called. This allows for
*  component Re-Start without re-initialization in all subsequent calls to the
*  ADC_SAR_ProxIR_Start() routine.
*  If re-initialization of the component is required the variable should be set
*  to zero before call of ADC_SAR_ProxIR_Start() routine, or the user may call
*  ADC_SAR_ProxIR_Init() and ADC_SAR_ProxIR_Enable() as done in the
*  ADC_SAR_ProxIR_Start() routine.
*
*******************************************************************************/
void ADC_SAR_ProxIR_Start(void)
{
    ...
    if(ADC_SAR_ProxIR_initVar == 0u)
    {
        ADC_SAR_ProxIR_Init();
        ADC_SAR_ProxIR_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_Init
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The ADC_SAR_ProxIR_offset variable is initialized to 0.
*
*******************************************************************************/
void ADC_SAR_ProxIR_Init(void)
{
    ...
    #if(ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK)
        ADC_SAR_ProxIR_theACLK_SetMode(CYCLK_DUTY);
    #endif /* End ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK */

    #if(ADC_SAR_ProxIR_IRQ_REMOVE == 0u)
        /* Start and set interrupt vector */
        CyIntSetPriority(ADC_SAR_ProxIR_INTC_NUMBER, ADC_SAR_ProxIR_INTC_PRIOR_NUMBER);
        (void)CyIntSetVector(ADC_SAR_ProxIR_INTC_NUMBER, &ADC_SAR_ProxIR_ISR);
    #endif   /* End ADC_SAR_ProxIR_IRQ_REMOVE */        

    /* Enable IRQ mode*/
    ADC_SAR_ProxIR_SAR_CSR1_REG |= ADC_SAR_ProxIR_SAR_IRQ_MASK_EN | ADC_SAR_ProxIR_SAR_IRQ_MODE_EDGE;

    /*Set SAR ADC resolution ADC */
    ADC_SAR_ProxIR_SetResolution(ADC_SAR_ProxIR_DEFAULT_RESOLUTION);
    ADC_SAR_ProxIR_offset = 0;
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_Enable
********************************************************************************
*
* Summary:
...
void ADC_SAR_ProxIR_Enable(void)
{
    ...
    ADC_SAR_ProxIR_PWRMGR_SAR_REG |= ADC_SAR_ProxIR_ACT_PWR_SAR_EN;
    ...
    /* This is only valid if there is an internal clock */
    #if(ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK)
        ADC_SAR_ProxIR_PWRMGR_CLK_REG |= ADC_SAR_ProxIR_ACT_PWR_CLK_EN;
        ADC_SAR_ProxIR_STBY_PWRMGR_CLK_REG |= ADC_SAR_ProxIR_STBY_PWR_CLK_EN;
    #endif /* End ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK */

    /* Enable VCM buffer and Enable Int Ref Amp */
    tmpReg = ADC_SAR_ProxIR_SAR_CSR3_REG;
    #if(CY_PSOC5A) /* Make sure that full power is applied for VREF buffer */
        tmpReg &= (uint8)~ADC_SAR_ProxIR_SAR_PWR_CTRL_VREF_DIV_BY4;
    #endif /* CY_PSOC5A */
    tmpReg |= ADC_SAR_ProxIR_SAR_EN_BUF_VCM_EN;
    /* PD_BUF_VREF is OFF in External reference or Vdda reference mode */
    #if((ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__EXT_REF) || \
        (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VDDA_DIFF))
        tmpReg &= (uint8)~ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN;
    #else /* In INTREF or INTREF Bypassed this buffer is ON */
        tmpReg |= ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN;
    #endif /* ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__EXT_REF */
    ADC_SAR_ProxIR_SAR_CSR3_REG = tmpReg;

    /* Set reference for ADC */
    #if(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VDDA_DIFF)
        #if(ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__EXT_REF)
            ADC_SAR_ProxIR_SAR_CSR6_REG = ADC_SAR_ProxIR_INT_BYPASS_EXT_VREF; /* S2 */
        #else /* Internal Vdda reference or obsolete bypass mode */
            ADC_SAR_ProxIR_SAR_CSR6_REG = ADC_SAR_ProxIR_VDDA_VREF;           /* S7 */
        #endif /* ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__EXT_REF */
    #else  /* Reference goes through internal buffer */
        #if(ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__INT_REF_NOT_BYPASSED)
            ADC_SAR_ProxIR_SAR_CSR6_REG = ADC_SAR_ProxIR_INT_VREF;            /* S3 + S4 */
        #else /* INTREF Bypassed of External */
            ADC_SAR_ProxIR_SAR_CSR6_REG = ADC_SAR_ProxIR_INT_BYPASS_EXT_VREF; /* S2 */
        #endif /* ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__INT_REF_NOT_BYPASSED */
    #endif /* VNEG_VDDA_DIFF */

    /* Low non-overlap delay for sampling clock signals (for 1MSPS) */
    #if(ADC_SAR_ProxIR_HIGH_POWER_PULSE == 0u) /* MinPulseWidth <= 50 ns */
        ADC_SAR_ProxIR_SAR_CSR5_REG &= (uint8)~ADC_SAR_ProxIR_SAR_DLY_INC;
    #else /* Set High non-overlap delay for sampling clock signals (for <500KSPS)*/
        ADC_SAR_ProxIR_SAR_CSR5_REG |= ADC_SAR_ProxIR_SAR_DLY_INC;
    #endif /* ADC_SAR_ProxIR_CLOCK_FREQUENCY > (ADC_SAR_ProxIR_MAX_FREQUENCY / 2) */

     /* Delay control for comparator latch enable, low delay, (Default for 1MSPS) */
    #if(ADC_SAR_ProxIR_HIGH_POWER_PULSE == 0u) /* MinPulseWidth <= 50 ns */
        ADC_SAR_ProxIR_SAR_CSR5_REG |= ADC_SAR_ProxIR_SAR_DCEN;
    #else /* Delay control for comparator latch enable, high delay (for <500ksps)*/
        ADC_SAR_ProxIR_SAR_CSR5_REG &= (uint8)~ADC_SAR_ProxIR_SAR_DCEN;
    #endif /* ADC_SAR_ProxIR_CLOCK_FREQUENCY > (ADC_SAR_ProxIR_MAX_FREQUENCY / 2) */

    /* Set default power and other configurations for control register 0 in multiple lines */
    ADC_SAR_ProxIR_SAR_CSR0_REG = (uint8)((uint8)ADC_SAR_ProxIR_DEFAULT_POWER << ADC_SAR_ProxIR_SAR_POWER_SHIFT)
    /* SAR_HIZ_CLEAR:   Should not be used for LP */
    #if ((CY_PSOC5LP) || (ADC_SAR_ProxIR_DEFAULT_REFERENCE != ADC_SAR_ProxIR__EXT_REF))
        | ADC_SAR_ProxIR_SAR_HIZ_CLEAR
    #endif /* SAR_HIZ_CLEAR */
    /*Set Convertion mode */
    #if(ADC_SAR_ProxIR_DEFAULT_CONV_MODE != ADC_SAR_ProxIR__FREE_RUNNING)      /* If triggered mode */
        | ADC_SAR_ProxIR_SAR_MX_SOF_UDB           /* source: UDB */
        | ADC_SAR_ProxIR_SAR_SOF_MODE_EDGE        /* Set edge-sensitive sof source */
    #endif /* ADC_SAR_ProxIR_DEFAULT_CONV_MODE */
    ...
    ADC_SAR_ProxIR_SAR_CLK_REG |= ADC_SAR_ProxIR_SAR_MX_CLK_EN;
        ...
        ADC_SAR_ProxIR_SAR_CSR0_REG &= (uint8)~ADC_SAR_ProxIR_SAR_RESET_SOFT_ACTIVE;
    #else
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_Stop
********************************************************************************
*
* Summary:
...
void ADC_SAR_ProxIR_Stop(void)
{
    ...
    ADC_SAR_ProxIR_SAR_CSR0_REG &= (uint8)~ADC_SAR_ProxIR_SAR_SOF_START_CONV;
        ...
        ADC_SAR_ProxIR_SAR_CSR6_REG &= (uint8)~ADC_SAR_ProxIR_INT_BYPASS_EXT_VREF;
        /* Disable reference buffer and reduce the reference power to the minimum */
        ADC_SAR_ProxIR_SAR_CSR3_REG &= (uint8)~ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN; /*VCM buffer is absent in PSOC5A*/
        ADC_SAR_ProxIR_SAR_CSR3_REG |= ADC_SAR_ProxIR_SAR_PWR_CTRL_VREF_DIV_BY4;
    #else
        /* Disable the SAR ADC block in Active Power Mode */
        ADC_SAR_ProxIR_PWRMGR_SAR_REG &= (uint8)~ADC_SAR_ProxIR_ACT_PWR_SAR_EN;
        /* Disable the SAR ADC in Standby Power Mode */
        ADC_SAR_ProxIR_STBY_PWRMGR_SAR_REG &= (uint8)~ADC_SAR_ProxIR_STBY_PWR_SAR_EN;
    #endif /* End CY_PSOC5A */

    /* This is only valid if there is an internal clock */
    #if(ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK)
        ADC_SAR_ProxIR_PWRMGR_CLK_REG &= (uint8)~ADC_SAR_ProxIR_ACT_PWR_CLK_EN;
        ADC_SAR_ProxIR_STBY_PWRMGR_CLK_REG &= (uint8)~ADC_SAR_ProxIR_STBY_PWR_CLK_EN;
    #endif /* End ADC_SAR_ProxIR_DEFAULT_INTERNAL_CLK */
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_SetPower
********************************************************************************
*
* Summary:
*  Sets the Power mode.
...
void ADC_SAR_ProxIR_SetPower(uint8 power)
{
    ...
    power &= ADC_SAR_ProxIR_SAR_API_POWER_MASK;

    /* Set Power parameter  */
    tmpReg = ADC_SAR_ProxIR_SAR_CSR0_REG & (uint8)~ADC_SAR_ProxIR_SAR_POWER_MASK;
    tmpReg |= (uint8)(power << ADC_SAR_ProxIR_SAR_POWER_SHIFT);
    ADC_SAR_ProxIR_SAR_CSR0_REG = tmpReg;
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_SetResolution
********************************************************************************
*
* Summary:
...
void ADC_SAR_ProxIR_SetResolution(uint8 resolution)
{
    ...
    switch (resolution)
    {
        case (uint8)ADC_SAR_ProxIR__BITS_12:
            tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_12BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
            break;
        case (uint8)ADC_SAR_ProxIR__BITS_10:
            ...
            */
                ...
                tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_12BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
            #else
                tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_10BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
            #endif /* End CY_PSOC5A */
            break;
        case (uint8)ADC_SAR_ProxIR__BITS_8:
            #if(CY_PSOC5A)
                tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_12BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
            #else
                tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_8BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
            #endif /* End CY_PSOC5A */
            break;
        default:
            tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_12BIT | ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;
    ...
    ADC_SAR_ProxIR_SAR_CSR2_REG = tmpReg;

     /* Calculate gain for convert counts to volts */
    ADC_SAR_ProxIR_CalcGain(resolution);
}
    ...
    /*******************************************************************************
    * Function Name: ADC_SAR_ProxIR_StartConvert
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        #if(ADC_SAR_ProxIR_DEFAULT_CONV_MODE != ADC_SAR_ProxIR__FREE_RUNNING)  /* If software triggered mode */
            ADC_SAR_ProxIR_SAR_CSR0_REG &= (uint8)~ADC_SAR_ProxIR_SAR_MX_SOF_UDB;   /* source: SOF bit */
        #endif /* End ADC_SAR_ProxIR_DEFAULT_CONV_MODE */
    ...
    /*******************************************************************************
    * Function Name: ADC_SAR_ProxIR_StopConvert
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    void ADC_SAR_ProxIR_StopConvert(void)
    {
        ...
        ADC_SAR_ProxIR_SAR_CSR0_REG &= (uint8)~ADC_SAR_ProxIR_SAR_SOF_START_CONV;
            ...
            ADC_SAR_ProxIR_SAR_CSR0_REG |= ADC_SAR_ProxIR_SAR_MX_SOF_UDB;    /* source: UDB */
        #endif /* End ADC_SAR_ProxIR_DEFAULT_CONV_MODE */
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_IsEndConversion
********************************************************************************
*
* Summary:
...
uint8 ADC_SAR_ProxIR_IsEndConversion(uint8 retMode)
{
    ...
    do
    {
        status = ADC_SAR_ProxIR_SAR_CSR1_REG & ADC_SAR_ProxIR_SAR_EOF_1;
    } while ((status != ADC_SAR_ProxIR_SAR_EOF_1) && (retMode == ADC_SAR_ProxIR_WAIT_FOR_RESULT));
    /* If convertion complete, wait until EOF bit released */
    if(status == ADC_SAR_ProxIR_SAR_EOF_1)
    {
        ...
        CY_GET_REG8(ADC_SAR_ProxIR_SAR_CSR1_PTR);
    }
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_GetResult8
********************************************************************************
*
* Summary:
*  Returns an 8-bit result or the LSB of the last conversion.
*  ADC_SAR_ProxIR_IsEndConversion() should be called to verify that the data
*   sample is ready
*
* Parameters:
*  None.
...
int8 ADC_SAR_ProxIR_GetResult8( void )
{
        ...
        return( (int8)((int16)res - ADC_SAR_ProxIR_shift) );
    #else
        return( (int8)ADC_SAR_ProxIR_SAR_WRK0_REG - (int8)ADC_SAR_ProxIR_shift);
    #endif /* End CY_PSOC5A */
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_GetResult16
********************************************************************************
*
* Summary:
...
int16 ADC_SAR_ProxIR_GetResult16( void )
{
    ...
    return( (int16)res - ADC_SAR_ProxIR_shift );
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_SetOffset
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  The ADC_SAR_ProxIR_offset variable modified. This variable is used for
*  offset calibration purpose.
*  Affects the ADC_SAR_ProxIR_CountsTo_Volts,
*  ADC_SAR_ProxIR_CountsTo_mVolts, ADC_SAR_ProxIR_CountsTo_uVolts functions
*  by subtracting the given offset.
*
*******************************************************************************/
void ADC_SAR_ProxIR_SetOffset(int16 offset)
{
    ADC_SAR_ProxIR_offset = offset;
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_CalcGain
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  ADC_SAR_ProxIR_shift variable initialized. This variable is used to
*  convert the ADC counts to the 2's compliment form.
*  ADC_SAR_ProxIR_countsPerVolt variable initialized. This variable is used
...
{
    int32 counts;
    #if(!((ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSS_TO_VREF) || \
         (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA) || \
         (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC)) )
        uint16 diff_zero;
    #endif /* End ADC_SAR_ProxIR_DEFAULT_RANGE */

    switch (resolution)
    {
        case (uint8)ADC_SAR_ProxIR__BITS_12:
            counts = (int32)ADC_SAR_ProxIR_SAR_WRK_MAX;
            #if(!((ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSS_TO_VREF) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC)) )
                diff_zero = ADC_SAR_ProxIR_SAR_DIFF_SHIFT;
            #endif /* End ADC_SAR_ProxIR_DEFAULT_RANGE */
            break;
        case (uint8)ADC_SAR_ProxIR__BITS_10:
            counts = (int32)(ADC_SAR_ProxIR_SAR_WRK_MAX >> 2u);
            #if(!((ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSS_TO_VREF) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC)) )
                diff_zero = ADC_SAR_ProxIR_SAR_DIFF_SHIFT >> 2u;
            #endif /* End ADC_SAR_ProxIR_DEFAULT_RANGE */
            break;
        case (uint8)ADC_SAR_ProxIR__BITS_8:
            counts = (int32)(ADC_SAR_ProxIR_SAR_WRK_MAX >> 4u);
            #if(!((ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSS_TO_VREF) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA) || \
                 (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC)) )
                diff_zero = ADC_SAR_ProxIR_SAR_DIFF_SHIFT >> 4u;
            #endif /* End ADC_SAR_ProxIR_DEFAULT_RANGE */
            break;
    ...
    ADC_SAR_ProxIR_countsPerVolt = (int16)(counts / ADC_SAR_ProxIR_DEFAULT_REF_VOLTAGE_MV / 2);

    #if( (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSS_TO_VREF) || \
         (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA) || \
         (ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC) )
        ADC_SAR_ProxIR_shift = 0;
    #else
        ADC_SAR_ProxIR_shift = diff_zero;
    #endif /* End ADC_SAR_ProxIR_DEFAULT_RANGE */
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_SetGain
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  ADC_SAR_ProxIR_countsPerVolt variable modified. This variable is used
*  for gain calibration purpose.
*
*******************************************************************************/
void ADC_SAR_ProxIR_SetGain(int16 adcGain)
{
    ADC_SAR_ProxIR_countsPerVolt = adcGain;
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_CountsTo_mVolts
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  ADC_SAR_ProxIR_offset variable used.
*  ADC_SAR_ProxIR_countsPerVolt variable used.
*
*******************************************************************************/
int16 ADC_SAR_ProxIR_CountsTo_mVolts(int16 adcCounts)
{
    ...
    /* Subtract ADC offset */
    adcCounts -= ADC_SAR_ProxIR_offset;

    mVolts = (int16)(( (int32)adcCounts * 1000 ) / ADC_SAR_ProxIR_countsPerVolt) ;
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_CountsTo_uVolts
********************************************************************************
*
* Summary:
...
int32 ADC_SAR_ProxIR_CountsTo_uVolts(int16 adcCounts)
{
    ...
    */
    uVolts = (( (int32)adcCounts * 500000 ) / ADC_SAR_ProxIR_countsPerVolt) * 2;
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_CountsTo_Volts
********************************************************************************
*
* Summary:
...
float32 ADC_SAR_ProxIR_CountsTo_Volts(int16 adcCounts)
{
    ...
    volts = (float32)adcCounts / (float32)ADC_SAR_ProxIR_countsPerVolt;
