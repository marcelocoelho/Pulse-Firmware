...
***************************************/
void ADC_SAR_ProxIR_SetRef(int8 refMode);
void ADC_SAR_ProxIR_CalcGain(uint8 resolution);
...
void ADC_SAR_ProxIR_Init(void)
{
    ...
    CyIntSetVector(ADC_SAR_ProxIR_INTC_NUMBER, ADC_SAR_ProxIR_ISR );
...
void ADC_SAR_ProxIR_Enable(void)
{
    ...
    /*Sets input range of the ADC*/
        ...
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR_DEFAULT_RANGE);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDDA)
        ADC_SAR_ProxIR_SAR_CSR3_REG = ADC_SAR_ProxIR_SAR_EN_RESVDA_EN;     /* Set bit for VDD/2 mode */
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR__VSSA_TO_VDDA);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VSSA_TO_VDAC)
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR_DEFAULT_RANGE);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VREF_DIFF)
        ADC_SAR_ProxIR_SAR_CSR3_REG = ADC_SAR_ProxIR_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR_DEFAULT_RANGE);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VDDA_DIFF)
        ADC_SAR_ProxIR_SAR_CSR3_REG = ADC_SAR_ProxIR_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR__VSSA_TO_VDDA);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VDDA_2_DIFF)
        ADC_SAR_ProxIR_SAR_CSR3_REG = ADC_SAR_ProxIR_SAR_EN_RESVDA_EN |    /* Set bit for VDD/2 mode*/
                                        ADC_SAR_ProxIR_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR__VSSA_TO_VDDA);
    #elif(ADC_SAR_ProxIR_DEFAULT_RANGE == ADC_SAR_ProxIR__VNEG_VDAC_DIFF)
        ADC_SAR_ProxIR_SetRef(ADC_SAR_ProxIR_DEFAULT_RANGE);
    #endif /* end ADC_SAR_ProxIR_DEFAULT_RANGE */

    /* Set default power */
    tmpReg = (ADC_SAR_ProxIR_DEFAULT_POWER << ADC_SAR_ProxIR_SAR_POWER_SHIFT);
    /* Clear DAC value at beginning of sampling when internal reference used */
        ...
        tmpReg |= ADC_SAR_ProxIR_SAR_HIZ_CLEAR;
    #endif /* End ADC_SAR_ProxIR_DEFAULT_REFERENCE != ADC_SAR_ProxIR__EXT_REF */    
    /*Set Convertion mode */
    #if(ADC_SAR_ProxIR_DEFAULT_CONV_MODE == ADC_SAR_ProxIR__TRIGGERED)      /* If triggered mode */
        tmpReg |= ADC_SAR_ProxIR_SAR_MX_SOF_UDB |          /* source: UDB */
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_SetRef
********************************************************************************
*
* Summary:
...
{
    uint8 tmpReg;
    if(refMode == ADC_SAR_ProxIR__VSSA_TO_VDDA)
    {
        #if(ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__INT_REF_NOT_BYPASSED)
            tmpReg = ADC_SAR_ProxIR_SAR_REF_S3_LSB_EN | ADC_SAR_ProxIR_SAR_REF_S4_LSB_EN;
            ADC_SAR_ProxIR_SAR_CSR3_REG |= ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN; /* Enable Int Ref Amp*/
        #elif(ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__INT_REF_BYPASS)
            tmpReg = ADC_SAR_ProxIR_SAR_REF_S2_LSB_EN | ADC_SAR_ProxIR_SAR_REF_S3_LSB_EN | 
                     ADC_SAR_ProxIR_SAR_REF_S4_LSB_EN;
            ADC_SAR_ProxIR_SAR_CSR3_REG |= ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN; /* Enable Int Ref Amp*/
        #elif(ADC_SAR_ProxIR_DEFAULT_REFERENCE == ADC_SAR_ProxIR__EXT_REF)
            tmpReg = ADC_SAR_ProxIR_SAR_REF_S2_LSB_EN;
            ADC_SAR_ProxIR_SAR_CSR3_REG &= ~ADC_SAR_ProxIR_SAR_EN_BUF_VREF_EN; /* Disable Int Ref Amp*/
...
/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_IRQ_Enable
********************************************************************************
* Summary:
...
void ADC_SAR_ProxIR_IRQ_Enable(void)
{
    ...
    CyIntEnable(ADC_SAR_ProxIR_INTC_NUMBER);
}


/*******************************************************************************
* Function Name: ADC_SAR_ProxIR_IRQ_Disable
********************************************************************************
*
* Summary:
...
void ADC_SAR_ProxIR_IRQ_Disable(void)
{
    ...
    CyIntDisable(ADC_SAR_ProxIR_INTC_NUMBER);
}
...
void ADC_SAR_ProxIR_SetPower(uint8 power)
{
    ...
    /* Set Power parameter  */
    tmpReg = ADC_SAR_ProxIR_SAR_CSR0_REG & ~ADC_SAR_ProxIR_SAR_POWER_MASK;
    tmpReg |= (power << ADC_SAR_ProxIR_SAR_POWER_SHIFT);
    ADC_SAR_ProxIR_SAR_CSR0_REG = tmpReg;
}
...
void ADC_SAR_ProxIR_SetResolution(uint8 resolution)
{
    ...
    switch (resolution)
    {
        case ADC_SAR_ProxIR__BITS_12:
            tmpReg = ADC_SAR_ProxIR_SAR_RESOLUTION_12BIT;
            break;
        case ADC_SAR_ProxIR__BITS_10:
     ...
     tmpReg |= ADC_SAR_ProxIR_SAR_SAMPLE_WIDTH;   /* 18 conversion cycles @ 12bits + 1 gap*/
...
{
    #if(ADC_SAR_ProxIR_DEFAULT_CONV_MODE == ADC_SAR_ProxIR__TRIGGERED)   /* If triggered mode */
        ADC_SAR_ProxIR_SAR_CSR0_REG &= ~ADC_SAR_ProxIR_SAR_MX_SOF_UDB;   /* source: SOF bit */
...
int8 ADC_SAR_ProxIR_GetResult8( void )
{
        ...
        else if(ADC_SAR_ProxIR_resolution == ADC_SAR_ProxIR__BITS_8)
        {
            res >>= 4u;
        }
...
void ADC_SAR_ProxIR_CalcGain( uint8 resolution )
{
    uint32 counts = ADC_SAR_ProxIR_SAR_WRK_MAX;       /*default 12 bits*/
    uint16 diff_zero = ADC_SAR_ProxIR_SAR_DIFF_SHIFT;
...
int16 ADC_SAR_ProxIR_CountsTo_mVolts(int16 adcCounts)
{
    ...
    mVolts = ( (int32)adcCounts * 1000 ) / ADC_SAR_ProxIR_countsPerVolt ;
...
float ADC_SAR_ProxIR_CountsTo_Volts(int16 adcCounts)
{
    ...
    volts = (float)adcCounts / (float)ADC_SAR_ProxIR_countsPerVolt;   
