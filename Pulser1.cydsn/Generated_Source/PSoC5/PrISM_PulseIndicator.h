...
/* PSoC3 ES2 or early */
#define PrISM_PulseIndicator_PSOC3_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                     (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2))

/* PSoC5 ES1 or early */
#define PrISM_PulseIndicator_PSOC5_ES1  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                     (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1))
/* PSoC3 ES3 or later */
#define PrISM_PulseIndicator_PSOC3_ES3  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                     (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_3A_ES2))

/* PSoC5 ES2 or later */
#define PrISM_PulseIndicator_PSOC5_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                     (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_5A_ES1))
...
typedef struct _PrISM_PulseIndicator_backupStruct
{
    ...
    uint8 seed_copy;
    uint8 polynom;
    #if(PrISM_PulseIndicator_PSOC3_ES2 || PrISM_PulseIndicator_PSOC5_ES1) /* PSoC3 ES2 or early, PSoC5 ES1*/
        uint8 density0;
        uint8 density1;
    #endif /*End PrISM_PulseIndicator_PSOC3_ES2 || PrISM_PulseIndicator_PSOC5_ES1*/
