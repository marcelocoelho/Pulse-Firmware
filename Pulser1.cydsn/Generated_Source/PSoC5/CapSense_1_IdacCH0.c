...
uint8 CapSense_1_IdacCH0_initVar = 0u;


#if (CY_PSOC5A)
    static CapSense_1_IdacCH0_LOWPOWER_BACKUP_STRUCT  CapSense_1_IdacCH0_lowPowerBackup;
#endif /* CY_PSOC5A */
...
void CapSense_1_IdacCH0_Enable(void) 
{
    ...
    #if (CY_PSOC5A)
        if(CapSense_1_IdacCH0_restoreReg == 1u)
        {
            CapSense_1_IdacCH0_CR0 = CapSense_1_IdacCH0_lowPowerBackup.DACCR0Reg;

            /* Clear the flag */
            CapSense_1_IdacCH0_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: CapSense_1_IdacCH0_Start
********************************************************************************
* Summary:
...
*
* Global variables:
*  CapSense_1_IdacCH0_initVar: Is modified when this function is called for 
...
void CapSense_1_IdacCH0_Start(void) 
{
    ...
    if ( CapSense_1_IdacCH0_initVar == 0u)  
    {
    ...
    /* Set default value */
    CapSense_1_IdacCH0_SetValue(CapSense_1_IdacCH0_DEFAULT_DATA);
...
void CapSense_1_IdacCH0_Stop(void) 
{
    ...
    CapSense_1_IdacCH0_STBY_PWRMGR &= ~CapSense_1_IdacCH0_STBY_PWR_EN;
        ...
        CapSense_1_IdacCH0_restoreReg = 1u;

        /* Save the control register and then Clear it. */
        CapSense_1_IdacCH0_lowPowerBackup.DACCR0Reg = CapSense_1_IdacCH0_CR0;
        CapSense_1_IdacCH0_CR0 = (CapSense_1_IdacCH0_MODE_I | CapSense_1_IdacCH0_RANGE_3 | CapSense_1_IdacCH0_HS_HIGHSPEED);
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: CapSense_1_IdacCH0_SetSpeed
********************************************************************************
* Summary:
*  Set DAC speed
*
...
/*******************************************************************************
* Function Name: CapSense_1_IdacCH0_SetPolarity
********************************************************************************
* Summary:
...
void CapSense_1_IdacCH0_SetValue(uint8 value) 
{
    ...
    #if (CY_PSOC5A)
        CapSense_1_IdacCH0_Data = value;
        CyExitCriticalSection(CapSense_1_IdacCH0_intrStatus);
    #endif /* CY_PSOC5A */
}
...
void CapSense_1_IdacCH0_DacTrim(void) 
{
    ...
    CapSense_1_IdacCH0_TR = CY_GET_XTND_REG8((uint8 *)(CapSense_1_IdacCH0_DAC_TRIM_BASE + mode));
}
