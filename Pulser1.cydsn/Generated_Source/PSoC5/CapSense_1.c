...
uint8 CYXDATA * const CYCODE CapSense_1_pcTable[] = {
    (uint8 CYXDATA *)CapSense_1_PortCH0__ProximitySensor0_0__PROX__PC, 
    (uint8 CYXDATA *)CapSense_1_PortCH0__ProximitySensor1_0__PROX__PC, 
};

const uint8 CYCODE CapSense_1_portTable[] = {
    CapSense_1_PortCH0__ProximitySensor0_0__PROX__PORT, 
    CapSense_1_PortCH0__ProximitySensor1_0__PROX__PORT, 
};

const uint8 CYCODE CapSense_1_maskTable[] = {
    CapSense_1_PortCH0__ProximitySensor0_0__PROX__MASK,
    CapSense_1_PortCH0__ProximitySensor1_0__PROX__MASK,
};
...
void CapSense_1_Init(void) 
{
    ...
    CyIntSetVector(CapSense_1_IsrCH0_ISR_NUMBER, CapSense_1_IsrCH0_ISR);
...
void CapSense_1_PreScan(uint8 sensor) CYREENTRANT
{
    ...
    ********************************************************************************/
    void CapSense_1_InitRb(void) 
    {
        ...
        /* Disable all Rb */
        for(i=0; i < CapSense_1_TOTAL_RB_NUMBER; i++)
        {
            /* Make High-Z */
    ...
    *
    * Global Variables:
    *  CapSense_1_RbCh0_cur - used to store current number of active 
    *  bleed resistor (Rb) of channel 0.
    *  CapSense_1_RbCh1_cur - used to store current number of active 
    ...
    *******************************************************************************/
    void CapSense_1_SetPrescaler(uint8 prescaler) CYREENTRANT
    {
        /* Set Prescaler */
            ...
            CapSense_1_PRESCALER_COMPARE_REG = (prescaler >> 0x01u);
        #elif (CapSense_1_PRESCALER_OPTIONS == CapSense_1_PRESCALER_FF)
