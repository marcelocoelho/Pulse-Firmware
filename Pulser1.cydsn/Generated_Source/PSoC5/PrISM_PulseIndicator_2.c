...
uint8 PrISM_PulseIndicator_2_initVar = 0u;


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The PrISM_PulseIndicator_2_initVar variable is used to indicate initial
*  configuration of this component.  The variable is initialized to zero and
*  set to 1 the first time PrISM_PulseIndicator_2_Start() is called. This allows for
*  component initialization without re-initialization in all subsequent calls
*  to the PrISM_PulseIndicator_2_Start() routine. 
...
void PrISM_PulseIndicator_2_Start(void) 
{
    ...
    if(PrISM_PulseIndicator_2_initVar == 0u)
    {
        PrISM_PulseIndicator_2_Init();
        PrISM_PulseIndicator_2_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: PrISM_PulseIndicator_2_Init
********************************************************************************
*
* Summary:
*  Initialize component's parameters to the parameters set by user in the 
*  customizer of the component placed onto schematic. Usually called in 
*  PrISM_PulseIndicator_2_Start().
*
* Parameters:  
*  None.
*
...
void PrISM_PulseIndicator_2_Init(void) 
{
    ...
    PrISM_PulseIndicator_2_WriteSeed(PrISM_PulseIndicator_2_SEED);
    PrISM_PulseIndicator_2_WritePolynomial(PrISM_PulseIndicator_2_POLYNOM);
    PrISM_PulseIndicator_2_WritePulse0(PrISM_PulseIndicator_2_DENSITY0);
    PrISM_PulseIndicator_2_WritePulse1(PrISM_PulseIndicator_2_DENSITY1);
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        if(PrISM_PulseIndicator_2_GREATERTHAN_OR_EQUAL == 0 )
        {
            PrISM_PulseIndicator_2_CONTROL_REG |= PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_PulseIndicator_2_CONTROL_REG &= ~PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        ...
        if(PrISM_PulseIndicator_2_GREATERTHAN_OR_EQUAL == 0)
        {
            PrISM_PulseIndicator_2_CONTROL_REG |= PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_PulseIndicator_2_CONTROL_REG &= ~PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
...
/*******************************************************************************
* Function Name: PrISM_PulseIndicator_2_Enable
********************************************************************************
*  
* Summary: 
...
void PrISM_PulseIndicator_2_Enable(void) 
{
        ...
        PrISM_PulseIndicator_2_CONTROL_REG |= PrISM_PulseIndicator_2_CTRL_ENABLE;
    #endif /* End PrISM_PulseIndicator_2_PULSE_TYPE_HARDCODED */
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_Stop
********************************************************************************
*
* Summary:
...
void PrISM_PulseIndicator_2_Stop(void) 
{
    ...
    /***************************************************************************
    * FUNCTION NAME:     PrISM_PulseIndicator_2_SetPulse0Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse0Type == PrISM_PulseIndicator_2_GREATERTHAN_OR_EQUAL)
        {
            PrISM_PulseIndicator_2_CONTROL_REG |= PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
    ...
    /***************************************************************************
    * FUNCTION NAME:   PrISM_PulseIndicator_2_SetPulse1Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse1Type == PrISM_PulseIndicator_2_GREATERTHAN_OR_EQUAL)
        {
            PrISM_PulseIndicator_2_CONTROL_REG |= PrISM_PulseIndicator_2_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
...
#endif /* End PrISM_PulseIndicator_2_PULSE_TYPE_HARDCODED == 0 */


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_ReadSeed
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_2_SEED_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_WriteSeed
********************************************************************************
*
* Summary:
...
void PrISM_PulseIndicator_2_WriteSeed(uint8 seed) 
{
    if(seed != 0u)
    {
        CY_SET_REG8(PrISM_PulseIndicator_2_SEED_COPY_PTR, seed);
        CY_SET_REG8(PrISM_PulseIndicator_2_SEED_PTR, seed);
    }
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_ReadPolynomial
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_2_POLYNOM_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_WritePolynomial
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_2_POLYNOM_PTR, polynomial);
    
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_ReadPulse0
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_2_DENSITY0_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_WritePulse0
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_2_DENSITY0_PTR, pulseDensity0);
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_ReadPulse1
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_PulseIndicator_2_DENSITY1_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_PulseIndicator_2_WritePulse1
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_PulseIndicator_2_DENSITY1_PTR, pulseDensity1);
}
