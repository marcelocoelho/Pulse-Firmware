...
typedef struct _PrISM_LEDBlue_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_LEDBlue_AUX_CONTROL2_PTR   ((reg32 *) PrISM_LEDBlue_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_LEDBlue_AUX_CONTROL2_PTR   ((reg32 *) PrISM_LEDBlue_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
