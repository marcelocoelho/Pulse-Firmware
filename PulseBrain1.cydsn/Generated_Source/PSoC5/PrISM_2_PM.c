...
static PrISM_2_BACKUP_STRUCT  PrISM_2_backup = 
{
    ...
    /* cr */
        ...
        (PrISM_2_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_2_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL : 0) |
        (PrISM_2_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_2_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL : 0),
...
void PrISM_2_RestoreConfig(void) 
{
        ...
        #elif (PrISM_2_RESOLUTION <= 24)   /* 24bit - PrISM */
