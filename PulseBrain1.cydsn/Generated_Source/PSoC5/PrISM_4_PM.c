...
static PrISM_4_BACKUP_STRUCT  PrISM_4_backup = 
{
    ...
    /* cr */
        ...
        (PrISM_4_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_4_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL : 0) |
        (PrISM_4_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_4_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL : 0),
...
void PrISM_4_RestoreConfig(void) 
{
        ...
        #elif (PrISM_4_RESOLUTION <= 24)   /* 24bit - PrISM */
