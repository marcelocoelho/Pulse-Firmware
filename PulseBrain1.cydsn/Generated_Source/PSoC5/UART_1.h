...
typedef struct _UART_1_backupStruct
{
    uint8 enableState;
...
#define UART_1_CTRL_PARITY_TYPE_MASK              (0x03u << UART_1_CTRL_PARITY_TYPE0_SHIFT)
...
#define UART_1_TXBITCTR_BREAKBITS   (UART_1_BREAK_BITS_TX * UART_1_OVER_SAMPLE_COUNT - 1u)
    ...
    #define UART_1_HD_RXBITCTR_INIT   ((UART_1_BREAK_BITS_RX + \
    UART_1_NUMBER_OF_START_BIT) * UART_1_OVER_SAMPLE_COUNT - 1u + \
    (UART_1_OVER_SAMPLE_COUNT / 2u) + (UART_1_USE23POLLING * 2u) - 1u)
#else /* UART_1_OVER_SAMPLE_COUNT == UART_1_OVER_SAMPLE_16 */
    #define UART_1_HD_TXBITCTR_INIT   (8u * UART_1_OVER_SAMPLE_COUNT - 1u)
    #define UART_1_HD_RXBITCTR_INIT   (7u * UART_1_OVER_SAMPLE_COUNT - 1u  +  \
       (UART_1_OVER_SAMPLE_COUNT / 2u) + (UART_1_USE23POLLING * 2u) - 1u)
...
#define UART_1_INIT_RX_INTERRUPTS_MASK \
                                          (1 << UART_1_RX_STS_FIFO_NOTEMPTY_SHIFT) \
...
#define UART_1_INIT_TX_INTERRUPTS_MASK \
                                          (0 << UART_1_TX_STS_COMPLETE_SHIFT) \
