...
typedef struct _PrISM_3_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_3_AUX_CONTROL2_PTR   ((reg32 *) PrISM_3_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_3_AUX_CONTROL2_PTR   ((reg32 *) PrISM_3_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
