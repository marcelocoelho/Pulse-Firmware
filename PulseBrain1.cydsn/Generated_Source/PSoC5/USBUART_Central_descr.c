/*******************************************************************************
* File Name: USBUART_Central_descr.c
* Version 2.50
*
* Description:
...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBUART_Central_DEVICE0_DESCR[] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBUART_Central_DEVICE0_CONFIGURATION0_DESCR[] = {
...
*********************************************************************/
const uint8 CYCODE USBUART_Central_STRING_DESCRIPTORS[] = {
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE USBUART_Central_SN_STRING_DESCRIPTOR[] = {
...
*********************************************************************/
const uint8 CYCODE USBUART_Central_HIDREPORT_DESCRIPTOR1[] = {
/*  Descriptor Size (Not part of descriptor)*/ USBUART_Central_HID_RPT_1_SIZE_LSB,
USBUART_Central_HID_RPT_1_SIZE_MSB,
...
*********************************************************************/
const T_USBUART_Central_EP_SETTINGS_BLOCK CYCODE USBUART_Central_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[] = {
...
const uint8 CYCODE USBUART_Central_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USBUART_Central_LUT CYCODE USBUART_Central_DEVICE0_CONFIGURATION0_TABLE[] = {
    {0x01u,     &USBUART_Central_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USBUART_Central_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USBUART_Central_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBUART_Central_LUT CYCODE USBUART_Central_DEVICE0_TABLE[] = {
    {0x01u,     &USBUART_Central_DEVICE0_DESCR},
    {0x01u,     &USBUART_Central_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBUART_Central_LUT CYCODE USBUART_Central_TABLE[] = {
    {0x01u,     &USBUART_Central_DEVICE0_TABLE}
};
    ...
    *  USBUART_Central_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBUART_Central_MSOS_DESCRIPTOR[] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature */                               'M', 0, 'S', 0, 'F', 0, 'T', 0, '1', 0, '0', 0, '0', 0,
    /* bMS_VendorCode:                         */   USBUART_Central_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBUART_Central_MSOS_CONFIGURATION_DESCR[] = {
...
#endif /* USBUART_Central_ENABLE_MSOS_STRING */
