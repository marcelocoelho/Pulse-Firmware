...
uint8 PrISM_10_initVar = 0u;


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The PrISM_10_initVar variable is used to indicate initial
*  configuration of this component.  The variable is initialized to zero and
*  set to 1 the first time PrISM_10_Start() is called. This allows for
*  component initialization without re-initialization in all subsequent calls
*  to the PrISM_10_Start() routine. 
...
void PrISM_10_Init(void) 
{
    ...
    PrISM_10_WriteSeed(PrISM_10_SEED);
    PrISM_10_WritePolynomial(PrISM_10_POLYNOM);
    PrISM_10_WritePulse0(PrISM_10_DENSITY0);
    PrISM_10_WritePulse1(PrISM_10_DENSITY1);
    
    enableInterrupts = CyEnterCriticalSection();
    /* Set FIFO0_CLR bit to use FIFO0 as a simple one-byte buffer*/
    #if (PrISM_10_RESOLUTION <= 8u)      /* 8bit - PrISM */
        PrISM_10_AUX_CONTROL_REG |= PrISM_10_FIFO0_CLR;
    #elif (PrISM_10_RESOLUTION <= 16u)   /* 16bit - PrISM */
        CY_SET_REG16(PrISM_10_AUX_CONTROL_PTR, CY_GET_REG16(PrISM_10_AUX_CONTROL_PTR) | 
                                        PrISM_10_FIFO0_CLR | PrISM_10_FIFO0_CLR << 8u);
    #elif (PrISM_10_RESOLUTION <= 24u)   /* 24bit - PrISM */
        CY_SET_REG24(PrISM_10_AUX_CONTROL_PTR, CY_GET_REG24(PrISM_10_AUX_CONTROL_PTR) |
                                        PrISM_10_FIFO0_CLR | PrISM_10_FIFO0_CLR << 8u );
        CY_SET_REG24(PrISM_10_AUX_CONTROL2_PTR, CY_GET_REG24(PrISM_10_AUX_CONTROL2_PTR) | 
                                        PrISM_10_FIFO0_CLR );
    #else                                 /* 32bit - PrISM */
        CY_SET_REG32(PrISM_10_AUX_CONTROL_PTR, CY_GET_REG32(PrISM_10_AUX_CONTROL_PTR) |
                                        PrISM_10_FIFO0_CLR | PrISM_10_FIFO0_CLR << 8u );
        CY_SET_REG32(PrISM_10_AUX_CONTROL2_PTR, CY_GET_REG32(PrISM_10_AUX_CONTROL2_PTR) |
                                        PrISM_10_FIFO0_CLR | PrISM_10_FIFO0_CLR << 8u );
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        if(PrISM_10_GREATERTHAN_OR_EQUAL == 0 )
        {
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_10_CONTROL_REG &= ~PrISM_10_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        ...
        if(PrISM_10_GREATERTHAN_OR_EQUAL == 0)
        {
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
        {
            PrISM_10_CONTROL_REG &= ~PrISM_10_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
...
void PrISM_10_Enable(void) 
{
        ...
        PrISM_10_CONTROL_REG |= PrISM_10_CTRL_ENABLE;
    #endif /* End PrISM_10_PULSE_TYPE_HARDCODED */
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_Stop
********************************************************************************
*
* Summary:
...
void PrISM_10_Stop(void) 
{
    ...
    /***************************************************************************
    * FUNCTION NAME:     PrISM_10_SetPulse0Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse0Type == PrISM_10_GREATERTHAN_OR_EQUAL)
        {
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
    ...
    /***************************************************************************
    * FUNCTION NAME:   PrISM_10_SetPulse1Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse1Type == PrISM_10_GREATERTHAN_OR_EQUAL)
        {
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
...
#endif /* End PrISM_10_PULSE_TYPE_HARDCODED == 0 */


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_ReadSeed
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_10_SEED_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_WriteSeed
********************************************************************************
*
* Summary:
...
void PrISM_10_WriteSeed(uint8 seed) 
{
    if(seed != 0u)
    {
        CY_SET_REG8(PrISM_10_SEED_COPY_PTR, seed);
        CY_SET_REG8(PrISM_10_SEED_PTR, seed);
    }
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_ReadPolynomial
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_10_POLYNOM_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_WritePolynomial
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_10_POLYNOM_PTR, polynomial);
    
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_ReadPulse0
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_10_DENSITY0_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_WritePulse0
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_10_DENSITY0_PTR, pulseDensity0);
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_ReadPulse1
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_10_DENSITY1_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_10_WritePulse1
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_10_DENSITY1_PTR, pulseDensity1);
}
