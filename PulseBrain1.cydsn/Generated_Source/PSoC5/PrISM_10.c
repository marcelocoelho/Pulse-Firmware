...
void PrISM_10_Init(void) 
{
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        #if(PrISM_10_GREATERTHAN_OR_EQUAL == PrISM_10_COMPARE0)
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_10_CONTROL_REG &= (uint8)~PrISM_10_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_10_COMPARE0 */    
    
        #if(PrISM_10_GREATERTHAN_OR_EQUAL == PrISM_10_COMPARE1)
            PrISM_10_CONTROL_REG |= PrISM_10_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_10_CONTROL_REG &= (uint8)~PrISM_10_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_10_COMPARE1 */    
...
{
    #if(!PrISM_10_PULSE_TYPE_HARDCODED)
        PrISM_10_CONTROL_REG &= (uint8)~PrISM_10_CTRL_ENABLE;
    #else
