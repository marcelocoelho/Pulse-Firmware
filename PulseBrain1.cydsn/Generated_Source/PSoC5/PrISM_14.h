...
typedef struct _PrISM_14_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_14_AUX_CONTROL2_PTR   ((reg32 *) PrISM_14_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_14_AUX_CONTROL2_PTR   ((reg32 *) PrISM_14_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
