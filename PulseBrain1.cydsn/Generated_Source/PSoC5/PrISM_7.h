...
#define PrISM_7_COMPARE0               (0u)
#define PrISM_7_COMPARE1               (0u)
...
***************************************/
    ...
    #define PrISM_7_AUX_CONTROL_PTR    (  (reg8 *) PrISM_7_sC8_PrISMdp_u0__DP_AUX_CTL_REG)
        ...
        #define PrISM_7_DENSITY0_PTR       ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_D0_REG)
        #define PrISM_7_DENSITY1_PTR       ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_D1_REG)
        #define PrISM_7_POLYNOM_PTR        ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_A1_REG)
        #define PrISM_7_SEED_PTR           ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_A0_REG)
        #define PrISM_7_SEED_COPY_PTR      ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_F0_REG)
        #define PrISM_7_AUX_CONTROL_PTR    ((reg16 *) PrISM_7_sC16_PrISMdp_u0__16BIT_DP_AUX_CTL_REG)
    #endif /* CY_PSOC3 */
    ...
    #define PrISM_7_AUX_CONTROL_PTR    ((reg32 *) PrISM_7_sC24_PrISMdp_u0__DP_AUX_CTL_REG)
        ...
        #define PrISM_7_DENSITY0_PTR       ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_D0_REG)
        #define PrISM_7_DENSITY1_PTR       ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_D1_REG)
        #define PrISM_7_POLYNOM_PTR        ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_A1_REG)
        #define PrISM_7_SEED_PTR           ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_A0_REG)
        #define PrISM_7_SEED_COPY_PTR      ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_F0_REG)
        #define PrISM_7_AUX_CONTROL_PTR    ((reg32 *) PrISM_7_sC32_PrISMdp_u0__32BIT_DP_AUX_CTL_REG)
    #endif
...
#elif (PrISM_7_RESOLUTION <= 16u) /* 16bit - PrISM */
    #define PrISM_7_FIFO0_CLR                              (0x0101u)
#elif (PrISM_7_RESOLUTION <= 24u) /* 24bit - PrISM */
    #define PrISM_7_FIFO0_CLR                              (0x010101Lu)
#else /* 32bit - PrISM */
    #define PrISM_7_FIFO0_CLR                              (0x01010101Lu)
#endif /* End PrISM_7_RESOLUTION */
