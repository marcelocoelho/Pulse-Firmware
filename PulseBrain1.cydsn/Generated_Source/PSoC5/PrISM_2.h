...
typedef struct _PrISM_2_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_2_AUX_CONTROL2_PTR   ((reg32 *) PrISM_2_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_2_AUX_CONTROL2_PTR   ((reg32 *) PrISM_2_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
