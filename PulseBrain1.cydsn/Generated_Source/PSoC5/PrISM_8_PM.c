...
static PrISM_8_BACKUP_STRUCT  PrISM_8_backup = 
{
    ...
    /* cr */
        ...
        (PrISM_8_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_8_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL : 0) |
        (PrISM_8_GREATERTHAN_OR_EQUAL == 0 ? \
                                                PrISM_8_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL : 0),
...
void PrISM_8_RestoreConfig(void) 
{
        ...
        #elif (PrISM_8_RESOLUTION <= 24)   /* 24bit - PrISM */
