...
#define UART_Debug_RX_ENABLED                     (1u)
...
#endif /* End UART_Debug_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG */
...
typedef struct _UART_Debug_backupStruct
{
    uint8 enableState;
...
/* Status Register definitions */
#if( (UART_Debug_TX_ENABLED) || (UART_Debug_HD_ENABLED) )
    #if(UART_Debug_TX_INTERRUPT_ENABLED)
        #define UART_Debug_TX_VECT_NUM                UART_Debug_TXInternalInterrupt__INTC_NUMBER
        #define UART_Debug_TX_PRIOR_NUM               UART_Debug_TXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* UART_Debug_TX_INTERRUPT_ENABLED */
    #if(UART_Debug_TX_ENABLED) 
    ...
    #define UART_Debug_TX_STS_COMPLETE                (0x01u << UART_Debug_TX_STS_COMPLETE_SHIFT)
    #define UART_Debug_TX_STS_FIFO_EMPTY              (0x01u << UART_Debug_TX_STS_FIFO_EMPTY_SHIFT)
    #define UART_Debug_TX_STS_FIFO_FULL               (0x01u << UART_Debug_TX_STS_FIFO_FULL_SHIFT)
    #define UART_Debug_TX_STS_FIFO_NOT_FULL           (0x01u << UART_Debug_TX_STS_FIFO_NOT_FULL_SHIFT)
#endif /* End (UART_Debug_TX_ENABLED) || (UART_Debug_HD_ENABLED)*/

#if( (UART_Debug_RX_ENABLED) || (UART_Debug_HD_ENABLED) )
    #if(UART_Debug_RX_INTERRUPT_ENABLED)
        #define UART_Debug_RX_VECT_NUM                UART_Debug_RXInternalInterrupt__INTC_NUMBER
        #define UART_Debug_RX_PRIOR_NUM               UART_Debug_RXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* UART_Debug_RX_INTERRUPT_ENABLED */
    ...
    #define UART_Debug_RX_STS_MRKSPC                  (0x01u << UART_Debug_RX_STS_MRKSPC_SHIFT)
    #define UART_Debug_RX_STS_BREAK                   (0x01u << UART_Debug_RX_STS_BREAK_SHIFT)
    #define UART_Debug_RX_STS_PAR_ERROR               (0x01u << UART_Debug_RX_STS_PAR_ERROR_SHIFT)
    #define UART_Debug_RX_STS_STOP_ERROR              (0x01u << UART_Debug_RX_STS_STOP_ERROR_SHIFT)
    #define UART_Debug_RX_STS_OVERRUN                 (0x01u << UART_Debug_RX_STS_OVERRUN_SHIFT)
    #define UART_Debug_RX_STS_FIFO_NOTEMPTY           (0x01u << UART_Debug_RX_STS_FIFO_NOTEMPTY_SHIFT)
    #define UART_Debug_RX_STS_ADDR_MATCH              (0x01u << UART_Debug_RX_STS_ADDR_MATCH_SHIFT)
    #define UART_Debug_RX_STS_SOFT_BUFF_OVER          (0x01u << UART_Debug_RX_STS_SOFT_BUFF_OVER_SHIFT)
...
#define UART_Debug_CTRL_HD_SEND                       (0x01u << UART_Debug_CTRL_HD_SEND_SHIFT)
#define UART_Debug_CTRL_HD_SEND_BREAK                 (0x01u << UART_Debug_CTRL_HD_SEND_BREAK_SHIFT)
#define UART_Debug_CTRL_MARK                          (0x01u << UART_Debug_CTRL_MARK_SHIFT)
#define UART_Debug_CTRL_PARITY_TYPE_MASK              (0x03u << UART_Debug_CTRL_PARITY_TYPE0_SHIFT)
#define UART_Debug_CTRL_RXADDR_MODE_MASK              (0x07u << UART_Debug_CTRL_RXADDR_MODE0_SHIFT)
...
#define UART_Debug_BIT_CENTER                         (UART_Debug_OVER_SAMPLE_COUNT - 1u)
...
#define UART_Debug_TXBITCTR_BREAKBITS   (UART_Debug_BREAK_BITS_TX * UART_Debug_OVER_SAMPLE_COUNT - 1u)
    ...
    #define UART_Debug_HD_RXBITCTR_INIT   ((UART_Debug_BREAK_BITS_RX + \
    UART_Debug_NUMBER_OF_START_BIT) * UART_Debug_OVER_SAMPLE_COUNT - 1u + \
    (UART_Debug_OVER_SAMPLE_COUNT / 2u) + (UART_Debug_USE23POLLING * 2u) - 1u)
    ...
    #define UART_Debug_HD_RXBITCTR_INIT   (7u * UART_Debug_OVER_SAMPLE_COUNT - 1u  +  \
       (UART_Debug_OVER_SAMPLE_COUNT / 2u) + (UART_Debug_USE23POLLING * 2u) - 1u)
...
#define UART_Debug_INIT_TX_INTERRUPTS_MASK \
                                          (0 << UART_Debug_TX_STS_COMPLETE_SHIFT) \
...
***************************************/
    ...
    #define UART_Debug_CONTROL_REG \
                            (* (reg8 *) UART_Debug_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG )
