...
#if !(CY_PSOC5A &&\
	 Pin_22__PORT == 15 && (Pin_22__MASK & 0xC0))
...
{
    uint8 staticBits = Pin_22_DR & ~Pin_22_MASK;
    Pin_22_DR = staticBits | ((value << Pin_22_SHIFT) & Pin_22_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_22_0, mode);
}
...
{
    return (Pin_22_PS & Pin_22_MASK) >> Pin_22_SHIFT;
}
...
{
    return (Pin_22_DR & Pin_22_MASK) >> Pin_22_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_22_INTSTAT & Pin_22_MASK) >> Pin_22_SHIFT;
    }
