...
{
    uint8 staticBits = Pin_28_DR & ~Pin_28_MASK;
    Pin_28_DR = staticBits | ((value << Pin_28_SHIFT) & Pin_28_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_28_0, mode);
}
...
*  
* Note:
*  Macro Pin_28_ReadPS calls this function. 
*  
*******************************************************************************/
uint8 Pin_28_Read(void) 
{
    return (Pin_28_PS & Pin_28_MASK) >> Pin_28_SHIFT;
}
...
{
    return (Pin_28_DR & Pin_28_MASK) >> Pin_28_SHIFT;
}


/* If Interrupts Are Enabled for this Pins component */ 
#if defined(Pin_28_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_28_INTSTAT & Pin_28_MASK) >> Pin_28_SHIFT;
    }
