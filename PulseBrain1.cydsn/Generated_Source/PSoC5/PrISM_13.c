...
uint8 PrISM_13_initVar = 0u;


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  The PrISM_13_initVar variable is used to indicate initial
*  configuration of this component.  The variable is initialized to zero and
*  set to 1 the first time PrISM_13_Start() is called. This allows for
*  component initialization without re-initialization in all subsequent calls
*  to the PrISM_13_Start() routine. 
...
void PrISM_13_Init(void) 
{
    ...
    PrISM_13_WriteSeed(PrISM_13_SEED);
    PrISM_13_WritePolynomial(PrISM_13_POLYNOM);
    PrISM_13_WritePulse0(PrISM_13_DENSITY0);
    PrISM_13_WritePulse1(PrISM_13_DENSITY1);
    
    enableInterrupts = CyEnterCriticalSection();
    /* Set FIFO0_CLR bit to use FIFO0 as a simple one-byte buffer*/
    CY_SET_REG8(PrISM_13_AUX_CONTROL_PTR, 
                        CY_GET_REG8(PrISM_13_AUX_CONTROL_PTR) | PrISM_13_FIFO0_CLR);
    CyExitCriticalSection(enableInterrupts);
    
    #if(!PrISM_13_PULSE_TYPE_HARDCODED)
        /* Writes density type provided by customizer */
        #if(PrISM_13_GREATERTHAN_OR_EQUAL == PrISM_13_COMPARE0)
            PrISM_13_CONTROL_REG |= PrISM_13_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_13_CONTROL_REG &= (uint8)~PrISM_13_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_13_COMPARE0 */    
    
        #if(PrISM_13_GREATERTHAN_OR_EQUAL == PrISM_13_COMPARE1)
            PrISM_13_CONTROL_REG |= PrISM_13_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_13_CONTROL_REG &= (uint8)~PrISM_13_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_13_COMPARE1 */    
    #endif /* End PrISM_13_PULSE_TYPE_HARDCODED */
}


/*******************************************************************************
* Function Name: PrISM_13_Enable
********************************************************************************
*  
* Summary: 
...
void PrISM_13_Enable(void) 
{
        ...
        PrISM_13_CONTROL_REG |= PrISM_13_CTRL_ENABLE;
    #endif /* End PrISM_13_PULSE_TYPE_HARDCODED */
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_Stop
********************************************************************************
*
* Summary:
...
{
    #if(!PrISM_13_PULSE_TYPE_HARDCODED)
        PrISM_13_CONTROL_REG &= (uint8)~PrISM_13_CTRL_ENABLE;
    #else
    ...
    /***************************************************************************
    * FUNCTION NAME:     PrISM_13_SetPulse0Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse0Type == PrISM_13_GREATERTHAN_OR_EQUAL)
        {
            PrISM_13_CONTROL_REG |= PrISM_13_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        }
        else
    ...
    /***************************************************************************
    * FUNCTION NAME:   PrISM_13_SetPulse1Mode
    ****************************************************************************
    *
    * Summary:
    ...
    ***************************************************************************/
    ...
    {
        if(pulse1Type == PrISM_13_GREATERTHAN_OR_EQUAL)
        {
            PrISM_13_CONTROL_REG |= PrISM_13_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        }
        else
...
#endif /* End PrISM_13_PULSE_TYPE_HARDCODED == 0 */


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_ReadSeed
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_13_SEED_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_WriteSeed
********************************************************************************
*
* Summary:
...
void PrISM_13_WriteSeed(uint8 seed) 
{
    if(seed != 0u)
    {
        CY_SET_REG8(PrISM_13_SEED_COPY_PTR, seed);
        CY_SET_REG8(PrISM_13_SEED_PTR, seed);
    }
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_ReadPolynomial
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_13_POLYNOM_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_WritePolynomial
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_13_POLYNOM_PTR, polynomial);
    
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_ReadPulse0
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_13_DENSITY0_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_WritePulse0
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_13_DENSITY0_PTR, pulseDensity0);
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_ReadPulse1
********************************************************************************
*
* Summary:
...
{
    return( CY_GET_REG8(PrISM_13_DENSITY1_PTR) );
}


/*******************************************************************************
* FUNCTION NAME:   PrISM_13_WritePulse1
********************************************************************************
*
* Summary:
...
{
    CY_SET_REG8(PrISM_13_DENSITY1_PTR, pulseDensity1);
}
