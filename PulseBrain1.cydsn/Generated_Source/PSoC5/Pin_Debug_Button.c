...
#if !(CY_PSOC5A &&\
	 Pin_Debug_Button__PORT == 15 && (Pin_Debug_Button__MASK & 0xC0))
...
{
    uint8 staticBits = Pin_Debug_Button_DR & ~Pin_Debug_Button_MASK;
    Pin_Debug_Button_DR = staticBits | ((value << Pin_Debug_Button_SHIFT) & Pin_Debug_Button_MASK);
}
