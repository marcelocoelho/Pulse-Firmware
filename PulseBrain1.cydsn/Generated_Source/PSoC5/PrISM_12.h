...
typedef struct _PrISM_12_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_12_AUX_CONTROL2_PTR   ((reg32 *) PrISM_12_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_12_AUX_CONTROL2_PTR   ((reg32 *) PrISM_12_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
