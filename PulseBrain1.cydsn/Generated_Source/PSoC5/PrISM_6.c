...
void PrISM_6_Init(void) 
{
    ...
    CyExitCriticalSection(enableInterrupts);
        ...
        #if(PrISM_6_GREATERTHAN_OR_EQUAL == PrISM_6_COMPARE0)
            PrISM_6_CONTROL_REG |= PrISM_6_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_6_CONTROL_REG &= (uint8)~PrISM_6_CTRL_COMPARE_TYPE0_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_6_COMPARE0 */    
    
        #if(PrISM_6_GREATERTHAN_OR_EQUAL == PrISM_6_COMPARE1)
            PrISM_6_CONTROL_REG |= PrISM_6_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #else
            PrISM_6_CONTROL_REG &= (uint8)~PrISM_6_CTRL_COMPARE_TYPE1_GREATER_THAN_OR_EQUAL;
        #endif /* End PrISM_6_COMPARE1 */    
...
{
    #if(!PrISM_6_PULSE_TYPE_HARDCODED)
        PrISM_6_CONTROL_REG &= (uint8)~PrISM_6_CTRL_ENABLE;
    #else
