...
#define PrISM_1_PULSE_TYPE_HARDCODED   (1u)
...
typedef struct _PrISM_1_backupStruct
{
    uint8 enableState;
...
***************************************/
    ...
    #define PrISM_1_AUX_CONTROL2_PTR   ((reg32 *) PrISM_1_sC24_PrISMdp_u2__DP_AUX_CTL_REG)
#else /* 32bit - PrISM */
    ...
    #define PrISM_1_AUX_CONTROL2_PTR   ((reg32 *) PrISM_1_sC32_PrISMdp_u2__DP_AUX_CTL_REG)
#endif /* End PrISM_1_RESOLUTION */

#define PrISM_1_CONTROL_REG   (* (reg8 *) PrISM_1_AsyncCtl_ControlReg__CONTROL_REG)
#define PrISM_1_CONTROL_PTR   (  (reg8 *) PrISM_1_AsyncCtl_ControlReg__CONTROL_REG)
