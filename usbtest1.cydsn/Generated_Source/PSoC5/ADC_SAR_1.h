...
extern volatile int16 ADC_SAR_1_countsPerVolt;
...
#if(CY_PSOC5A)
    #define ADC_SAR_1_MAX_FREQUENCY          (14000000)       /*14Mhz*/
#else
...
#define ADC_SAR_1_DEFAULT_RANGE          (4u)       /* ADC Input Range selection */
#define ADC_SAR_1_CLOCK_FREQUENCY        (1900000u)   /* Clock frequency */
#define ADC_SAR_1_NOMINAL_CLOCK_FREQ     (1941176)  /* Nominal Clock Frequency */
...
#define ADC_SAR_1_DEFAULT_POWER \
       ((ADC_SAR_1_NOMINAL_CLOCK_FREQ > (ADC_SAR_1_MAX_FREQUENCY / 2)) ? ADC_SAR_1__HIGHPOWER : \
       ((ADC_SAR_1_NOMINAL_CLOCK_FREQ > (ADC_SAR_1_MAX_FREQUENCY / 4)) ? ADC_SAR_1__MEDPOWER : \
                                                                                        ADC_SAR_1__MINPOWER))
/* Constant for a global usage */
/* Number of additional clocks for sampling data*/
#define ADC_SAR_1_SAMPLE_PRECHARGE       (7u)
...
#if(CY_PSOC5A)
    #define ADC_SAR_1_SAR_CSR7_REG               (* (reg8 *) ADC_SAR_1_ADC_SAR__CSR7 )
    #define ADC_SAR_1_SAR_CSR7_PTR               (  (reg8 *) ADC_SAR_1_ADC_SAR__CSR7 )
#endif /* End CY_PSOC5A */
